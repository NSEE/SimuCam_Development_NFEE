...
set_module_property DISPLAY_NAME Synchronization_COMM
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL scom_synchronization_comm_top
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file scom_avs_config_pkg.vhd VHDL PATH Synchronization_COMM/AVS_CONFIG_REGISTERS/scom_avs_config_pkg.vhd
add_fileset_file scom_avs_config_registers_pkg.vhd VHDL PATH Synchronization_COMM/AVS_CONFIG_REGISTERS/scom_avs_config_registers_pkg.vhd
add_fileset_file scom_avs_config_read_ent.vhd VHDL PATH Synchronization_COMM/AVS_CONFIG_REGISTERS/scom_avs_config_read_ent.vhd
add_fileset_file scom_avs_config_write_ent.vhd VHDL PATH Synchronization_COMM/AVS_CONFIG_REGISTERS/scom_avs_config_write_ent.vhd
add_fileset_file scom_config_avalon_mm_stimulli.vhd VHDL PATH Synchronization_COMM/AVS_CONFIG_REGISTERS/scom_config_avalon_mm_stimulli.vhd
add_fileset_file scom_sync_manager_ent.vhd VHDL PATH Synchronization_COMM/OTHERS_MANAGERS/scom_sync_manager_ent.vhd
add_fileset_file scom_frame_manager_ent.vhd VHDL PATH Synchronization_COMM/OTHERS_MANAGERS/scom_frame_manager_ent.vhd
add_fileset_file scom_restart_manager_ent.vhd VHDL PATH Synchronization_COMM/OTHERS_MANAGERS/scom_restart_manager_ent.vhd
add_fileset_file scom_timecode_manager_ent.vhd VHDL PATH Synchronization_COMM/OTHERS_MANAGERS/scom_timecode_manager_ent.vhd
add_fileset_file spw_codec_pkg.vhd VHDL PATH Synchronization_COMM/SPW_CODEC/spw_codec_pkg.vhd
add_fileset_file spw_mux_ent.vhd VHDL PATH Synchronization_COMM/SPW_MUX/spw_mux_ent.vhd
add_fileset_file fee_data_controller_pkg.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/fee_data_controller_pkg.vhd
add_fileset_file fee_data_manager_ent.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/FEE_DATA_MANAGER/fee_data_manager_ent.vhd
add_fileset_file fee_hkdata_manager_ent.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/FEE_DATA_MANAGER/fee_hkdata_manager_ent.vhd
add_fileset_file data_packet_header_gen_ent.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/DATA_PACKET/data_packet_header_gen_ent.vhd
add_fileset_file data_packet_hk_writer_ent.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/DATA_PACKET/data_packet_hk_writer_ent.vhd
add_fileset_file send_buffer_sc_1k_fifo.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/SEND_BUFFER/altera_ip/scfifo/send_buffer_sc_1k_fifo/send_buffer_sc_1k_fifo.vhd
add_fileset_file scom_send_buffer_ent.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/SEND_BUFFER/scom_send_buffer_ent.vhd
add_fileset_file comm_data_transmitter_pkg.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/DATA_TRANSMITTER/comm_data_transmitter_pkg.vhd
add_fileset_file comm_data_transmitter_manager_ent.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/DATA_TRANSMITTER/comm_data_transmitter_manager_ent.vhd
add_fileset_file comm_data_transmitter_housekeep_ent.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/DATA_TRANSMITTER/comm_data_transmitter_housekeep_ent.vhd
add_fileset_file comm_data_transmitter_fullimage_ent.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/DATA_TRANSMITTER/comm_data_transmitter_fullimage_ent.vhd
add_fileset_file comm_data_transmitter_windowing_ent.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/DATA_TRANSMITTER/comm_data_transmitter_windowing_ent.vhd
add_fileset_file comm_data_transmitter_top.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/DATA_TRANSMITTER/comm_data_transmitter_top.vhd
add_fileset_file fee_hkdata_controller_top.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/fee_hkdata_controller_top.vhd
add_fileset_file scom_data_controller_top.vhd VHDL PATH Synchronization_COMM/FEE_DATA_CONTROLLER/scom_data_controller_top.vhd
add_fileset_file rmap_target_crc_pkg.vhd VHDL PATH Synchronization_COMM/RMAP_TARGET/rmap_target_crc_pkg.vhd
add_fileset_file rmap_target_pkg.vhd VHDL PATH Synchronization_COMM/RMAP_TARGET/rmap_target_pkg.vhd
add_fileset_file rmap_target_command_ent.vhd VHDL PATH Synchronization_COMM/RMAP_TARGET/rmap_target_command_ent.vhd
add_fileset_file rmap_target_reply_ent.vhd VHDL PATH Synchronization_COMM/RMAP_TARGET/rmap_target_reply_ent.vhd
add_fileset_file rmap_target_read_ent.vhd VHDL PATH Synchronization_COMM/RMAP_TARGET/rmap_target_read_ent.vhd
add_fileset_file rmap_target_write_ent.vhd VHDL PATH Synchronization_COMM/RMAP_TARGET/rmap_target_write_ent.vhd
add_fileset_file rmap_target_user_ent.vhd VHDL PATH Synchronization_COMM/RMAP_TARGET/rmap_target_user_ent.vhd
add_fileset_file rmap_target_top.vhd VHDL PATH Synchronization_COMM/RMAP_TARGET/rmap_target_top.vhd
add_fileset_file scom_synchronization_comm_top.vhd VHDL PATH Synchronization_COMM/scom_synchronization_comm_top.vhd TOP_LEVEL_FILE

add_fileset SIM_VHDL SIM_VHDL "" ""
set_fileset_property SIM_VHDL TOP_LEVEL scom_synchronization_comm_top
