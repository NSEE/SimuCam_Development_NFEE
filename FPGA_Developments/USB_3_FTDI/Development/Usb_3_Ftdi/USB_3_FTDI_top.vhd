...
begin
	...
	ftdi_protocol_top_inst : entity work.ftdi_protocol_top
		port map(
			...
			req_half_ccd_width_i                 => s_config_write_registers.hccd_req_control_reg.req_hccd_cdd_width,
			...
			rly_half_ccd_width_o                 => s_config_read_registers.hccd_reply_status_reg.rly_hccd_cdd_width,
