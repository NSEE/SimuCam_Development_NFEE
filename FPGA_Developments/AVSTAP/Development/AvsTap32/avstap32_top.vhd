...
entity avstap32_top is
	port(
		...
		avalon_slave_32_byteenable  : in  std_logic_vector(3 downto 0)  := (others => '0') ---                .byteenable
	);
end entity avstap32_top;

architecture rtl of avstap32_top is
...
begin
	...
	avalon_mm_32_read_ent_inst : entity work.avalon_mm_32_read_ent
		port map(
			...
			avalon_mm_32_i.byteenable  => avalon_slave_32_byteenable,
...
end architecture rtl;                   -- of avstap32_top
