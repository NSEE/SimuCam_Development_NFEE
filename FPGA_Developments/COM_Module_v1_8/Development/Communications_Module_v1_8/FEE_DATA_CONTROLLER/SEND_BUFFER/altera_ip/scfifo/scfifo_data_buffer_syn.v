...
// ============================================================
// File Name: scfifo_data_buffer.v
// Megafunction Name(s):
// 			scfifo
//
...
module  scfifo_data_buffer_decode
	( 
	data,
	enable,
...
endmodule //scfifo_data_buffer_decode
...
endmodule //scfifo_data_buffer_mux
...
module  scfifo_data_buffer_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
`endif
	...
	scfifo_data_buffer_decode   decode2
	( 
	.data(address_a_wire[14:13]),
	.enable(wren_a),
	.eq(wire_decode2_eq));
	scfifo_data_buffer_decode   wren_decode_a
	( 
	.data(w_addr_val_a343w),
	.enable(wren_a),
	.eq(wire_wren_decode_a_eq));
	scfifo_data_buffer_mux   mux3
	( 
...
endmodule //scfifo_data_buffer_altsyncram
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  scfifo_data_buffer_cmpr
	( 
	aeb,
	dataa,
...
endmodule //scfifo_data_buffer_cmpr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  scfifo_data_buffer_cntr
	( 
	aclr,
	clock,
	cnt_en,
...
endmodule //scfifo_data_buffer_cntr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  scfifo_data_buffer_cntr1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //scfifo_data_buffer_cntr1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  scfifo_data_buffer_cntr12
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //scfifo_data_buffer_cntr12

//synthesis_resources = lut 60 M9K 32 reg 69 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  scfifo_data_buffer_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	scfifo_data_buffer_altsyncram   FIFOram
	( 
	...
	.q(wire_rd_ptr_msb_q),
	.sclr(sclr));
	scfifo_data_buffer_cntr1   usedw_counter
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.sclr(sclr),
	.updown(valid_wreq));
	scfifo_data_buffer_cntr12   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
...
endmodule //scfifo_data_buffer_a_dpfifo

//synthesis_resources = lut 60 M9K 32 reg 71 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  scfifo_data_buffer_scfifo
	( 
	aclr,
	almost_empty,
	almost_full,
...
`endif
	...
	scfifo_data_buffer_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
...
endmodule //scfifo_data_buffer_scfifo
//VALID FILE
...
module scfifo_data_buffer (
	...
	scfifo_data_buffer_scfifo	scfifo_data_buffer_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
