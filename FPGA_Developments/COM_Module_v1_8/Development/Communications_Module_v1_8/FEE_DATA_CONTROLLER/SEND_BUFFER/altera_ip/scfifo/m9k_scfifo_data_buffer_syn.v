...
// ============================================================
// File Name: m9k_scfifo_data_buffer.v
// Megafunction Name(s):
// 			scfifo
//
...
module  m9k_scfifo_data_buffer_decode
	( 
	data,
	enable,
...
`endif
	...
	wire  [3:0]  eq_node;
	wire  [3:0]  eq_wire;
	wire  [2:0]  w_anode619w;
	wire  [2:0]  w_anode632w;
	wire  [2:0]  w_anode640w;
	wire  [2:0]  w_anode648w;
	...
	assign
		...
		eq = eq_node,
		eq_node = eq_wire[3:0],
		eq_wire = {w_anode648w[2], w_anode640w[2], w_anode632w[2], w_anode619w[2]},
		w_anode619w = {(w_anode619w[1] & (~ data_wire[1])), (w_anode619w[0] & (~ data_wire[0])), enable_wire},
		w_anode632w = {(w_anode632w[1] & (~ data_wire[1])), (w_anode632w[0] & data_wire[0]), enable_wire},
		w_anode640w = {(w_anode640w[1] & data_wire[1]), (w_anode640w[0] & (~ data_wire[0])), enable_wire},
		w_anode648w = {(w_anode648w[1] & data_wire[1]), (w_anode648w[0] & data_wire[0]), enable_wire};
endmodule //m9k_scfifo_data_buffer_decode
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m9k_scfifo_data_buffer_mux
	( 
	data,
	result,
...
endmodule //m9k_scfifo_data_buffer_mux

//synthesis_resources = lut 16 M9K 32 reg 4 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"OPTIMIZE_POWER_DURING_SYNTHESIS=NORMAL_COMPILATION"} *)
module  m9k_scfifo_data_buffer_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
`endif
	...
	m9k_scfifo_data_buffer_decode   decode2
	( 
	.data(address_a_wire[14:13]),
	.enable(wren_a),
	.eq(wire_decode2_eq));
	m9k_scfifo_data_buffer_decode   wren_decode_a
	( 
	.data(w_addr_val_a343w),
	.enable(wren_a),
	.eq(wire_wren_decode_a_eq));
	m9k_scfifo_data_buffer_mux   mux3
	( 
	...
	assign
		...
		w_addr_val_a343w = wren_decode_addr_sel_a,
		wren_decode_addr_sel_a = address_a_wire[14:13];
endmodule //m9k_scfifo_data_buffer_altsyncram
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m9k_scfifo_data_buffer_cmpr
	( 
	aeb,
	dataa,
...
endmodule //m9k_scfifo_data_buffer_cmpr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m9k_scfifo_data_buffer_cntr
	( 
	aclr,
	clock,
	cnt_en,
...
endmodule //m9k_scfifo_data_buffer_cntr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m9k_scfifo_data_buffer_cntr1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //m9k_scfifo_data_buffer_cntr1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m9k_scfifo_data_buffer_cntr12
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //m9k_scfifo_data_buffer_cntr12

//synthesis_resources = lut 60 M9K 32 reg 69 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m9k_scfifo_data_buffer_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	m9k_scfifo_data_buffer_altsyncram   FIFOram
	( 
	...
	m9k_scfifo_data_buffer_cmpr   almost_full_comparer
	( 
	.aeb(wire_almost_full_comparer_aeb),
	.dataa({15{1'b1}}),
	.datab(wire_usedw_counter_q));
	m9k_scfifo_data_buffer_cmpr   two_comparison
	( 
	.aeb(wire_two_comparison_aeb),
	.dataa(wire_usedw_counter_q),
	.datab({{13{1'b0}}, 1'b1, 1'b0}));
	m9k_scfifo_data_buffer_cntr   rd_ptr_msb
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.q(wire_rd_ptr_msb_q),
	.sclr(sclr));
	m9k_scfifo_data_buffer_cntr1   usedw_counter
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.sclr(sclr),
	.updown(valid_wreq));
	m9k_scfifo_data_buffer_cntr12   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
...
endmodule //m9k_scfifo_data_buffer_a_dpfifo

//synthesis_resources = lut 60 M9K 32 reg 71 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m9k_scfifo_data_buffer_scfifo
	( 
	aclr,
	almost_empty,
	almost_full,
...
`endif
	...
	m9k_scfifo_data_buffer_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
...
endmodule //m9k_scfifo_data_buffer_scfifo
//VALID FILE
...
module m9k_scfifo_data_buffer (
	...
	m9k_scfifo_data_buffer_scfifo	m9k_scfifo_data_buffer_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
