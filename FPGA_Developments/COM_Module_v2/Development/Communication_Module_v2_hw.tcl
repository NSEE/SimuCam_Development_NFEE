...
add_interface_port conduit_end_rmap_echo_out rmap_echo_id_en_o echo_id_en_signal Output 1
add_interface_port conduit_end_rmap_echo_out rmap_in_fifo_wrflag_o in_fifo_wflag_signal Output 1
add_interface_port conduit_end_rmap_echo_out rmap_in_fifo_wrdata_o in_fifo_wdata_signal Output 8 
add_interface_port conduit_end_rmap_echo_out rmap_in_fifo_wrreq_o in_fifo_wrreq_signal Output 1
add_interface_port conduit_end_rmap_echo_out rmap_out_fifo_wrflag_o out_fifo_wrflag_signal Output 1
add_interface_port conduit_end_rmap_echo_out rmap_out_fifo_wrdata_o out_fifo_wrdata_signal Output 8 
add_interface_port conduit_end_rmap_echo_out rmap_out_fifo_wrreq_o out_fifo_wrreq_signal Output 1
