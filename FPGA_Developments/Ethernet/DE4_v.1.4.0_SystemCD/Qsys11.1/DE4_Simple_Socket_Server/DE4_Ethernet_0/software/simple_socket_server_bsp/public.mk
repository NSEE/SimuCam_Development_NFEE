...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DE4_Ethernet.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x5101ce0
SOPC_SYSID_FLAG += --sidp=0x5101ce0
ELF_PATCH_FLAG  += --sidp 0x5101ce0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1328247942
SOPC_SYSID_FLAG += --timestamp=1328247942
ELF_PATCH_FLAG  += --timestamp 1328247942
