...
# ACDS 16.1 196 win32 2017.06.23.17:22:14
# ----------------------------------------
...
alias com {
  echo "\[exec\] com"
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS                                             "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_avalon_st_adapter_016_error_adapter_0.sv"               -work error_adapter_0                             
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS                                             "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                                -work rsp_mux                                     
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS                                             "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_rsp_demux_015.sv"                                       -work rsp_demux_015                               
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS                                             "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_rsp_demux_009.sv"                                       -work rsp_demux_009                               
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS                                             "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_rsp_demux_002.sv"                                       -work rsp_demux_002                               
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS                                             "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_cmd_mux_015.sv"                                         -work cmd_mux_015                                 
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS                                             "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                                -work cmd_mux_015                                 
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS                                             "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_cmd_mux_009.sv"                                         -work cmd_mux_009                                 
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS                                             "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                                -work cmd_mux_009                                 
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS                                             "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_cmd_mux_002.sv"                                         -work cmd_mux_002                                 
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS                                             "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_router_014.sv"                                          -work router_014                                  
  ...
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS                                        "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                                    -work FTDI_0_FTDI_avalon_slave_agent_rsp_fifo     
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS                                             "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                                               -work FTDI_0_FTDI_avalon_slave_agent              
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS                                             "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                                        -work FTDI_0_FTDI_avalon_slave_agent              
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L error_adapter_0 -L a0 -L ng0 -L timing_adapter_0 -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_001 -L router -L avalon_st_adapter_016 -L avalon_st_adapter_010 -L avalon_st_adapter_002 -L avalon_st_adapter -L crosser -L dma_M1_M2_descriptor_slave_cmd_width_adapter -L rsp_mux_002 -L rsp_mux_001 -L rsp_demux_015 -L rsp_demux_014 -L rsp_demux_013 -L rsp_demux_009 -L rsp_demux_002 -L cmd_mux_015 -L cmd_mux_014 -L cmd_mux_009 -L cmd_mux_002 -L cmd_demux_002 -L cmd_demux_001 -L m2_ddr2_memory_avl_burst_adapter -L nios2_gen2_0_instruction_master_limiter -L router_028 -L router_027 -L router_026 -L router_025 -L router_022 -L router_021 -L router_014 -L router_012 -L router_010 -L router_008 -L router_004 -L router_002 -L FTDI_0_FTDI_avalon_slave_agent_rsp_fifo -L FTDI_0_FTDI_avalon_slave_agent -L nios2_gen2_0_data_master_agent -L nios2_gen2_0_data_master_translator -L i_tse_pcs_0 -L avalon_arbiter -L i_tse_mac -L cpu -L s0 -L p0 -L pll0 -L dll0 -L oct0 -L c0 -L m0 -L tda -L slave_translator -L tdt -L write_mstr_internal -L read_mstr_internal -L dispatcher_internal -L rst_controller -L avalon_st_adapter_001 -L irq_synchronizer -L irq_mapper -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L tse_mac -L tristate_conduit_bridge_0 -L timer_1us -L timer_1ms -L sysid_qsys -L sgdma_tx -L sgdma_rx -L sd_dat -L pio_LED_painel -L pio_LED -L pio_EXT -L pio_DIP -L pio_BUTTON -L onchip_memory -L nios2_gen2_0 -L m2_ddr2_memory -L m1_ddr2_memory -L m1_ddr2_i2c_sda -L jtag_uart_0 -L ext_flash -L dma_M2_M1 -L dma_M1_M2 -L descriptor_memory -L csense_sdo -L csense_cs_n -L csense_adc_fo -L clock_bridge_afi_50 -L SEVEN_SEGMENT_CONTROLLER_0 -L FTDI_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L stratixiv_hssi_ver -L stratixiv_pcie_hip_ver -L stratixiv_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L stratixiv_hssi -L stratixiv_pcie_hip -L stratixiv $TOP_LEVEL_NAME
}
