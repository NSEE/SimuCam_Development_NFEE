-- srme_rmap_memory_scom_area_top.vhd
...
architecture rtl of srme_rmap_memory_scom_area_top is
    ...
    signal s_fee_wr_rmap_cfg_hk_in             : t_srme_scom_rmap_write_in;
    signal s_fee_wr_rmap_cfg_hk_out            : t_srme_scom_rmap_write_out;
    signal s_fee_rd_rmap_cfg_hk_in             : t_srme_scom_rmap_read_in;
    signal s_fee_rd_rmap_cfg_hk_out            : t_srme_scom_rmap_read_out;
    -- avs rmap signals
    signal s_avalon_mm_wr_rmap_in              : t_srme_avalon_mm_rmap_scom_write_in;
    signal s_avalon_mm_wr_rmap_out             : t_srme_avalon_mm_rmap_scom_write_out;
...
begin
    ...
    srme_rmap_mem_area_scom_arbiter_ent_inst : entity work.srme_rmap_mem_area_scom_arbiter_ent
        port map(
            clk_i                             => a_avs_clock,
            rst_i                             => a_reset,
    ...
    srme_rmap_mem_area_scom_read_ent_inst : entity work.srme_rmap_mem_area_scom_read_ent
        port map(
            clk_i               => a_avs_clock,
            rst_i               => a_reset,
    ...
    srme_rmap_mem_area_scom_write_ent_inst : entity work.srme_rmap_mem_area_scom_write_ent
        port map(
            clk_i               => a_avs_clock,
            rst_i               => a_reset,
    ...
    end process p_srme_scom_rmap_error_clear_manager;
...
end architecture rtl;                   -- of srme_rmap_memory_scom_area_top
