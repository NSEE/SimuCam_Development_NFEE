...
architecture rtl of nrme_rmap_memory_nfee_area_top is
    ...
    -- mem area signals
    signal s_memarea_wraddress                 : std_logic_vector(5 downto 0);
    ...
    signal s_memarea_rdaddress                 : std_logic_vector(5 downto 0);
...
begin
    ...
    nrme_mem_area_altsyncram_controller_inst : entity work.nrme_mem_area_altsyncram_controller
        port map(
            clk_i                  => a_avs_clock,
            rst_i                  => a_reset,
