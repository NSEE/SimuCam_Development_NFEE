...
module MebX_Qsys_Project_mm_interconnect_0 (
	...
	wire  [155:0] ddr2_address_span_extender_cntl_agent_rp_data;                                      // ddr2_address_span_extender_cntl_agent:rp_data -> router_009:sink_data
	...
	wire          tse_mac_control_port_agent_rp_valid;                                                // tse_mac_control_port_agent:rp_valid -> router_010:sink_valid
	wire  [119:0] tse_mac_control_port_agent_rp_data;                                                 // tse_mac_control_port_agent:rp_data -> router_010:sink_data
	wire          tse_mac_control_port_agent_rp_ready;                                                // router_010:sink_ready -> tse_mac_control_port_agent:rp_ready
	wire          tse_mac_control_port_agent_rp_startofpacket;                                        // tse_mac_control_port_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          tse_mac_control_port_agent_rp_endofpacket;                                          // tse_mac_control_port_agent:rp_endofpacket -> router_010:sink_endofpacket
	wire          router_010_src_valid;                                                               // router_010:src_valid -> rsp_demux_002:sink_valid
	wire  [119:0] router_010_src_data;                                                                // router_010:src_data -> rsp_demux_002:sink_data
	...
	wire  [119:0] sysid_qsys_control_slave_agent_rp_data;                                             // sysid_qsys_control_slave_agent:rp_data -> router_011:sink_data
	...
	wire  [119:0] sgdma_tx_csr_agent_rp_data;                                                         // sgdma_tx_csr_agent:rp_data -> router_012:sink_data
	...
	wire          sgdma_rx_csr_agent_rp_valid;                                                        // sgdma_rx_csr_agent:rp_valid -> router_013:sink_valid
	wire  [119:0] sgdma_rx_csr_agent_rp_data;                                                         // sgdma_rx_csr_agent:rp_data -> router_013:sink_data
	wire          sgdma_rx_csr_agent_rp_ready;                                                        // router_013:sink_ready -> sgdma_rx_csr_agent:rp_ready
	wire          sgdma_rx_csr_agent_rp_startofpacket;                                                // sgdma_rx_csr_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          sgdma_rx_csr_agent_rp_endofpacket;                                                  // sgdma_rx_csr_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire          dma_m1_m2_csr_agent_rp_valid;                                                       // dma_M1_M2_csr_agent:rp_valid -> router_014:sink_valid
	wire  [119:0] dma_m1_m2_csr_agent_rp_data;                                                        // dma_M1_M2_csr_agent:rp_data -> router_014:sink_data
	wire          dma_m1_m2_csr_agent_rp_ready;                                                       // router_014:sink_ready -> dma_M1_M2_csr_agent:rp_ready
	wire          dma_m1_m2_csr_agent_rp_startofpacket;                                               // dma_M1_M2_csr_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire          dma_m1_m2_csr_agent_rp_endofpacket;                                                 // dma_M1_M2_csr_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire          dma_m2_m1_csr_agent_rp_valid;                                                       // dma_M2_M1_csr_agent:rp_valid -> router_015:sink_valid
	wire  [119:0] dma_m2_m1_csr_agent_rp_data;                                                        // dma_M2_M1_csr_agent:rp_data -> router_015:sink_data
	wire          dma_m2_m1_csr_agent_rp_ready;                                                       // router_015:sink_ready -> dma_M2_M1_csr_agent:rp_ready
	wire          dma_m2_m1_csr_agent_rp_startofpacket;                                               // dma_M2_M1_csr_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          dma_m2_m1_csr_agent_rp_endofpacket;                                                 // dma_M2_M1_csr_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire          dma_m1_m2_descriptor_slave_agent_rp_valid;                                          // dma_M1_M2_descriptor_slave_agent:rp_valid -> router_017:sink_valid
	wire  [227:0] dma_m1_m2_descriptor_slave_agent_rp_data;                                           // dma_M1_M2_descriptor_slave_agent:rp_data -> router_017:sink_data
	wire          dma_m1_m2_descriptor_slave_agent_rp_ready;                                          // router_017:sink_ready -> dma_M1_M2_descriptor_slave_agent:rp_ready
	wire          dma_m1_m2_descriptor_slave_agent_rp_startofpacket;                                  // dma_M1_M2_descriptor_slave_agent:rp_startofpacket -> router_017:sink_startofpacket
	wire          dma_m1_m2_descriptor_slave_agent_rp_endofpacket;                                    // dma_M1_M2_descriptor_slave_agent:rp_endofpacket -> router_017:sink_endofpacket
	wire          dma_m2_m1_descriptor_slave_agent_rp_valid;                                          // dma_M2_M1_descriptor_slave_agent:rp_valid -> router_018:sink_valid
	wire  [227:0] dma_m2_m1_descriptor_slave_agent_rp_data;                                           // dma_M2_M1_descriptor_slave_agent:rp_data -> router_018:sink_data
	wire          dma_m2_m1_descriptor_slave_agent_rp_ready;                                          // router_018:sink_ready -> dma_M2_M1_descriptor_slave_agent:rp_ready
	wire          dma_m2_m1_descriptor_slave_agent_rp_startofpacket;                                  // dma_M2_M1_descriptor_slave_agent:rp_startofpacket -> router_018:sink_startofpacket
	wire          dma_m2_m1_descriptor_slave_agent_rp_endofpacket;                                    // dma_M2_M1_descriptor_slave_agent:rp_endofpacket -> router_018:sink_endofpacket
	wire          clock_bridge_afi_50_s0_agent_rp_valid;                                              // clock_bridge_afi_50_s0_agent:rp_valid -> router_019:sink_valid
	wire  [119:0] clock_bridge_afi_50_s0_agent_rp_data;                                               // clock_bridge_afi_50_s0_agent:rp_data -> router_019:sink_data
	...
	wire   [15:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> ddr2_address_span_extender_cntl_cmd_width_adapter:in_channel
	...
	wire  [155:0] router_009_src_data;                                                                // router_009:src_data -> ddr2_address_span_extender_cntl_rsp_width_adapter:in_data
	wire          router_009_src_ready;                                                               // ddr2_address_span_extender_cntl_rsp_width_adapter:in_ready -> router_009:src_ready
	wire   [15:0] router_009_src_channel;                                                             // router_009:src_channel -> ddr2_address_span_extender_cntl_rsp_width_adapter:in_channel
	...
	wire   [15:0] ddr2_address_span_extender_cntl_rsp_width_adapter_src_channel;                      // ddr2_address_span_extender_cntl_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire          router_017_src_valid;                                                               // router_017:src_valid -> dma_M1_M2_descriptor_slave_rsp_width_adapter:in_valid
	wire  [227:0] router_017_src_data;                                                                // router_017:src_data -> dma_M1_M2_descriptor_slave_rsp_width_adapter:in_data
	wire          router_017_src_ready;                                                               // dma_M1_M2_descriptor_slave_rsp_width_adapter:in_ready -> router_017:src_ready
	wire   [15:0] router_017_src_channel;                                                             // router_017:src_channel -> dma_M1_M2_descriptor_slave_rsp_width_adapter:in_channel
	wire          router_017_src_startofpacket;                                                       // router_017:src_startofpacket -> dma_M1_M2_descriptor_slave_rsp_width_adapter:in_startofpacket
	wire          router_017_src_endofpacket;                                                         // router_017:src_endofpacket -> dma_M1_M2_descriptor_slave_rsp_width_adapter:in_endofpacket
	...
	wire          router_018_src_valid;                                                               // router_018:src_valid -> dma_M2_M1_descriptor_slave_rsp_width_adapter:in_valid
	wire  [227:0] router_018_src_data;                                                                // router_018:src_data -> dma_M2_M1_descriptor_slave_rsp_width_adapter:in_data
	wire          router_018_src_ready;                                                               // dma_M2_M1_descriptor_slave_rsp_width_adapter:in_ready -> router_018:src_ready
	wire   [15:0] router_018_src_channel;                                                             // router_018:src_channel -> dma_M2_M1_descriptor_slave_rsp_width_adapter:in_channel
	wire          router_018_src_startofpacket;                                                       // router_018:src_startofpacket -> dma_M2_M1_descriptor_slave_rsp_width_adapter:in_startofpacket
	wire          router_018_src_endofpacket;                                                         // router_018:src_endofpacket -> dma_M2_M1_descriptor_slave_rsp_width_adapter:in_endofpacket
	...
	MebX_Qsys_Project_mm_interconnect_0_router_008 router_010 (
