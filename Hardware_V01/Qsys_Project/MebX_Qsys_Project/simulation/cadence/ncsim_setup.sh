...
# ACDS 16.1 196 win32 2017.12.05.15:49:59
...
mkdir -p ./libraries/avalon_st_adapter_015/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS                                     "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_avalon_st_adapter_015_error_adapter_0.sv"               -work error_adapter_0                              -cdslib ./cds_libs/error_adapter_0.cds.lib                             
  ...
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS                                    "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_avalon_st_adapter_015.vhd"                              -work avalon_st_adapter_015                        -cdslib ./cds_libs/avalon_st_adapter_015.cds.lib                       
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS                                     "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_rsp_demux_001.sv"                                       -work rsp_demux_001                                -cdslib ./cds_libs/rsp_demux_001.cds.lib                               
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS                                     "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_cmd_mux_001.sv"                                         -work cmd_mux_001                                  -cdslib ./cds_libs/cmd_mux_001.cds.lib                                 
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS                                     "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_router_013.sv"                                          -work router_013                                   -cdslib ./cds_libs/router_013.cds.lib                                  
