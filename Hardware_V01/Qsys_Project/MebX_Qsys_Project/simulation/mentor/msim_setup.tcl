...
# ----------------------------------------
# ACDS 16.1 196 win32 2017.10.02.19:43:03
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS                                      "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_avalon_st_adapter_015_error_adapter_0.sv"               -work error_adapter_0                             
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS                                      "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_rsp_demux_001.sv"                                       -work rsp_demux_001                               
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS                                      "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_cmd_mux_001.sv"                                         -work cmd_mux_001                                 
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS                                      "$QSYS_SIMDIR/submodules/MebX_Qsys_Project_mm_interconnect_0_router_013.sv"                                          -work router_013                                  
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L error_adapter_0 -L a0 -L ng0 -L timing_adapter_0 -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_001 -L router -L avalon_st_adapter_015 -L avalon_st_adapter_009 -L avalon_st_adapter_001 -L avalon_st_adapter -L crosser -L dma_M1_M2_descriptor_slave_cmd_width_adapter -L rsp_mux_002 -L rsp_mux_001 -L rsp_demux_014 -L rsp_demux_013 -L rsp_demux_012 -L rsp_demux_008 -L rsp_demux_001 -L cmd_mux_014 -L cmd_mux_013 -L cmd_mux_008 -L cmd_mux_001 -L cmd_demux_002 -L cmd_demux_001 -L m2_ddr2_memory_avl_burst_adapter -L nios2_gen2_0_instruction_master_limiter -L router_027 -L router_026 -L router_025 -L router_024 -L router_021 -L router_020 -L router_013 -L router_012 -L router_010 -L router_008 -L router_004 -L router_002 -L jtag_uart_0_avalon_jtag_slave_agent_rsp_fifo -L jtag_uart_0_avalon_jtag_slave_agent -L nios2_gen2_0_data_master_agent -L nios2_gen2_0_data_master_translator -L i_tse_pcs_0 -L avalon_arbiter -L i_tse_mac -L cpu -L s0 -L p0 -L pll0 -L dll0 -L oct0 -L c0 -L m0 -L tda -L slave_translator -L tdt -L write_mstr_internal -L read_mstr_internal -L dispatcher_internal -L rst_controller -L irq_synchronizer -L irq_mapper -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L tse_mac -L tristate_conduit_bridge_0 -L timer_1us -L timer_1ms -L sysid_qsys -L sgdma_tx -L sgdma_rx -L sd_dat -L pio_LED_painel -L pio_LED -L pio_EXT -L pio_DIP -L pio_BUTTON -L onchip_memory -L nios2_gen2_0 -L m2_ddr2_memory -L m1_ddr2_memory -L m1_ddr2_i2c_sda -L jtag_uart_0 -L ext_flash -L dma_M2_M1 -L dma_M1_M2 -L descriptor_memory -L csense_sdo -L csense_cs_n -L csense_adc_fo -L clock_bridge_afi_50 -L SEVEN_SEGMENT_CONTROLLER_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L stratixiv_hssi_ver -L stratixiv_pcie_hip_ver -L stratixiv_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L stratixiv_hssi -L stratixiv_pcie_hip -L stratixiv $TOP_LEVEL_NAME
}
