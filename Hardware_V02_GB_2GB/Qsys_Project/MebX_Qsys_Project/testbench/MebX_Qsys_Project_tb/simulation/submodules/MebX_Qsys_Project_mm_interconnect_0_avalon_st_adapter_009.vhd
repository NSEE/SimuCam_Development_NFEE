-- MebX_Qsys_Project_mm_interconnect_0_avalon_st_adapter_009.vhd
...
entity MebX_Qsys_Project_mm_interconnect_0_avalon_st_adapter_009 is
	generic (
		inBitsPerSymbol : integer := 130;
		inUsePackets    : integer := 0;
		inDataWidth     : integer := 130;
	...
	port (
		...
		in_0_data      : in  std_logic_vector(129 downto 0) := (others => '0'); --     in_0.data
		in_0_valid     : in  std_logic                      := '0';             --         .valid
		in_0_ready     : out std_logic;                                         --         .ready
		out_0_data     : out std_logic_vector(129 downto 0);                    --    out_0.data
		out_0_valid    : out std_logic;                                         --         .valid
		out_0_ready    : in  std_logic                      := '0';             --         .ready
		out_0_error    : out std_logic_vector(0 downto 0)                       --         .error
	);
end entity MebX_Qsys_Project_mm_interconnect_0_avalon_st_adapter_009;

architecture rtl of MebX_Qsys_Project_mm_interconnect_0_avalon_st_adapter_009 is
	component MebX_Qsys_Project_mm_interconnect_0_avalon_st_adapter_009_error_adapter_0 is
		port (
			clk       : in  std_logic                      := 'X';             -- clk
			reset_n   : in  std_logic                      := 'X';             -- reset_n
			in_data   : in  std_logic_vector(129 downto 0) := (others => 'X'); -- data
			in_valid  : in  std_logic                      := 'X';             -- valid
			in_ready  : out std_logic;                                         -- ready
			out_data  : out std_logic_vector(129 downto 0);                    -- data
			out_valid : out std_logic;                                         -- valid
			out_ready : in  std_logic                      := 'X';             -- ready
			out_error : out std_logic_vector(0 downto 0)                       -- error
		);
	end component MebX_Qsys_Project_mm_interconnect_0_avalon_st_adapter_009_error_adapter_0;

	signal in_rst_0_reset_ports_inv : std_logic; -- in_rst_0_reset:inv -> error_adapter_0:reset_n

begin

	inbitspersymbol_check : if inBitsPerSymbol /= 130 generate
	...
	indatawidth_check : if inDataWidth /= 130 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	outdatawidth_check : if outDataWidth /= 130 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	error_adapter_0 : component MebX_Qsys_Project_mm_interconnect_0_avalon_st_adapter_009_error_adapter_0
		port map (
...
end architecture rtl; -- of MebX_Qsys_Project_mm_interconnect_0_avalon_st_adapter_009
