 ...
 */
	...
	void SPWC_WRITE_REG32(char c_SpwID, alt_u8 uc_RegisterAddress, alt_u32 ul_RegisterValue){
		switch (c_SpwID) {
			...
			break;
			case 'B':
				alt_u32 *pSpwcAddr = SPWC_B_BASE;
			break;
			case 'C':
				alt_u32 *pSpwcAddr = SPWC_C_BASE;
			break;
			case 'D':
				alt_u32 *pSpwcAddr = SPWC_D_BASE;
			break;
			case 'E':
				alt_u32 *pSpwcAddr = SPWC_E_BASE;
			break;
			case 'F':
				alt_u32 *pSpwcAddr = SPWC_F_BASE;
			break;
			case 'G':
				alt_u32 *pSpwcAddr = SPWC_G_BASE;
			break;
			case 'H':
				alt_u32 *pSpwcAddr = SPWC_H_BASE;
			break;
			default:
				alt_u32 *pSpwcAddr = SPWC_A_BASE;
		}
	...
	bool b_SpaceWire_Interface_Enable_Control(char c_SpwID, alt_u8 uc_RegisterOperation, alt_u32 ul_EnableMask){
		...
		switch (c_SpwID) {
			...
			break;
			case 'B':
				alt_u32 *ul_spwc_interface_control_status_register_value = &ul_spwc_b_interface_control_status_register_value;
				bSuccess = TRUE;
			break;
			case 'C':
				alt_u32 *ul_spwc_interface_control_status_register_value = &ul_spwc_c_interface_control_status_register_value;
				bSuccess = TRUE;
			break;
			case 'D':
				alt_u32 *ul_spwc_interface_control_status_register_value = &ul_spwc_d_interface_control_status_register_value;
				bSuccess = TRUE;
			break;
			case 'E':
				alt_u32 *ul_spwc_interface_control_status_register_value = &ul_spwc_e_interface_control_status_register_value;
				bSuccess = TRUE;
			break;
			case 'F':
				alt_u32 *ul_spwc_interface_control_status_register_value = &ul_spwc_f_interface_control_status_register_value;
				bSuccess = TRUE;
			break;
			case 'G':
				alt_u32 *ul_spwc_interface_control_status_register_value = &ul_spwc_g_interface_control_status_register_value;
				bSuccess = TRUE;
			break;
			case 'H':
				alt_u32 *ul_spwc_interface_control_status_register_value = &ul_spwc_h_interface_control_status_register_value;
				bSuccess = TRUE;
			break;
			default:
				alt_u32 *ul_spwc_interface_control_status_register_value = &ul_spwc_a_interface_control_status_register_value;
	...
	bool v_SpaceWire_Interface_Link_Control(char c_SpwID, alt_u8 uc_RegisterOperation, alt_u32 ul_ControlMask){
		...
		switch (c_SpwID) {
			...
			break;
			case 'B':
				alt_u32 *ul_spwc_spacewire_link_control_status_register_value = &ul_spwc_b_spacewire_link_control_status_register_value;
				bSuccess = TRUE;
			break;
			case 'C':
				alt_u32 *ul_spwc_spacewire_link_control_status_register_value = &ul_spwc_c_spacewire_link_control_status_register_value;
				bSuccess = TRUE;
			break;
			case 'D':
				alt_u32 *ul_spwc_spacewire_link_control_status_register_value = &ul_spwc_d_spacewire_link_control_status_register_value;
				bSuccess = TRUE;
			break;
			case 'E':
				alt_u32 *ul_spwc_spacewire_link_control_status_register_value = &ul_spwc_e_spacewire_link_control_status_register_value;
				bSuccess = TRUE;
			break;
			case 'F':
				alt_u32 *ul_spwc_spacewire_link_control_status_register_value = &ul_spwc_f_spacewire_link_control_status_register_value;
				bSuccess = TRUE;
			break;
			case 'G':
				alt_u32 *ul_spwc_spacewire_link_control_status_register_value = &ul_spwc_g_spacewire_link_control_status_register_value;
				bSuccess = TRUE;
			break;
			case 'H':
				alt_u32 *ul_spwc_spacewire_link_control_status_register_value = &ul_spwc_h_spacewire_link_control_status_register_value;
				bSuccess = TRUE;
			break;
			default:
				alt_u32 *ul_spwc_spacewire_link_control_status_register_value = &ul_spwc_a_spacewire_link_control_status_register_value;
