...
MEM_0 := MebX_Qsys_Project_descriptor_memory
...
$(MEM_0)_START := 0x81200800
$(MEM_0)_END := 0x81200fff
...
# Memory: m1_ddr2_memory
MEM_2 := m1_ddr2_memory
$(MEM_2)_NAME := m1_ddr2_memory
$(MEM_2)_MEM_INIT_FILE_PARAM_NAME := ABS_RAM_MEM_INIT_FILENAME
$(MEM_2)_START := 0x00000000
$(MEM_2)_END := 0x3fffffff
$(MEM_2)_SPAN := 0x40000000
$(MEM_2)_HIERARCHICAL_PATH := m1_ddr2_memory
$(MEM_2)_WIDTH := 256
$(MEM_2)_HEX_DATA_WIDTH := 256
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0


# Memory: m2_ddr2_memory
MEM_3 := m2_ddr2_memory
$(MEM_3)_NAME := m2_ddr2_memory
$(MEM_3)_MEM_INIT_FILE_PARAM_NAME := ABS_RAM_MEM_INIT_FILENAME
$(MEM_3)_START := 0x40000000
$(MEM_3)_END := 0x7fffffff
$(MEM_3)_SPAN := 0x40000000
$(MEM_3)_HIERARCHICAL_PATH := m2_ddr2_memory
$(MEM_3)_WIDTH := 256
$(MEM_3)_HEX_DATA_WIDTH := 256
$(MEM_3)_ENDIANNESS := --little-endian-mem
$(MEM_3)_CREATE_LANES := 0


# Memory: onchip_memory
MEM_4 := MebX_Qsys_Project_onchip_memory
$(MEM_4)_NAME := onchip_memory
...
$(MEM_4)_START := 0x81100000
$(MEM_4)_END := 0x811f9fff
$(MEM_4)_SPAN := 0x000fa000
$(MEM_4)_HIERARCHICAL_PATH := onchip_memory
$(MEM_4)_WIDTH := 32
...
.PHONY: onchip_memory
onchip_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_4).hex $(HDL_SIM_DIR)/$(MEM_4).dat $(HDL_SIM_DIR)/$(MEM_4).sym
