...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80002480
SOPC_SYSID_FLAG += --sidp=0x80002480
ELF_PATCH_FLAG  += --sidp 0x80002480

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1569730357
SOPC_SYSID_FLAG += --timestamp=1569730357
ELF_PATCH_FLAG  += --timestamp 1569730357
...
# setting hal.stdin is rs232_uart
ELF_PATCH_FLAG  += --stdin_dev rs232_uart
...
# setting hal.stdout is rs232_uart
ELF_PATCH_FLAG  += --stdout_dev rs232_uart
