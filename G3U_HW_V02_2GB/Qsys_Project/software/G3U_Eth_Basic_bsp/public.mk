...
# setting SOPC_SYSID_BASE_ADDRESS is 0x822020c0
SOPC_SYSID_FLAG += --sidp=0x822020c0
ELF_PATCH_FLAG  += --sidp 0x822020c0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1525115449
SOPC_SYSID_FLAG += --timestamp=1525115449
ELF_PATCH_FLAG  += --timestamp 1525115449
