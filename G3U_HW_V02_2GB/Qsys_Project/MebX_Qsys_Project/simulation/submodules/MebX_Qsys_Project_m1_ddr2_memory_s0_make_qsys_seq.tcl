...
lappend arg_list "--component-param=CALIB_VFIFO_OFFSET=11"
...
lappend arg_list "--component-param=MEM_T_RL=4"
...
lappend arg_list "--component-param=MR0_CAS_LATENCY=4"
...
lappend arg_list "--component-param=SEQ_ROM=MebX_Qsys_Project_m1_ddr2_memory_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=MebX_Qsys_Project_m1_ddr2_memory_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=MebX_Qsys_Project_m1_ddr2_memory_s0_inst_ROM.hex"
...
lappend arg_list "--output-name=MebX_Qsys_Project_m1_ddr2_memory_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=STRATIXIV"
lappend arg_list "--report-file=sopcinfo:MebX_Qsys_Project_m1_ddr2_memory_s0.sopcinfo"
lappend arg_list "--report-file=txt:MebX_Qsys_Project_m1_ddr2_memory_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=SIM_VERILOG"
catch { eval [concat [list exec "C:/intelfpga/16.1/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
