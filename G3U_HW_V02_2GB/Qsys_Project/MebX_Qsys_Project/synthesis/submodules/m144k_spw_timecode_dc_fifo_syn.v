...
// ============================================================
// File Name: m144k_spw_timecode_dc_fifo.v
// Megafunction Name(s):
// 			dcfifo
//
...
module  m144k_spw_timecode_dc_fifo_a_gray2bin
	( 
	bin,
	...
	assign
		...
		xor0 = (gray[0] ^ xor1),
		xor1 = (gray[2] ^ gray[1]);
endmodule //m144k_spw_timecode_dc_fifo_a_gray2bin
...
module  m144k_spw_timecode_dc_fifo_a_graycounter
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		sclr = 1'b0,
		updown = 1'b1;
endmodule //m144k_spw_timecode_dc_fifo_a_graycounter
...
module  m144k_spw_timecode_dc_fifo_a_graycounter1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		sclr = 1'b0,
		updown = 1'b1;
endmodule //m144k_spw_timecode_dc_fifo_a_graycounter1


//altsyncram ADDRESS_ACLR_B="CLEAR1" ADDRESS_REG_B="CLOCK1" CLOCK_ENABLE_INPUT_B="BYPASS" DEVICE_FAMILY="Stratix IV" ENABLE_ECC="FALSE" OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="CLEAR1" OUTDATA_REG_B="CLOCK1" RAM_BLOCK_TYPE="M144K" WIDTH_A=8 WIDTH_B=8 WIDTH_BYTEENA_A=1 WIDTH_ECCSTATUS=2 WIDTHAD_A=2 WIDTHAD_B=2 aclr1 address_a address_b addressstall_b clock0 clock1 clocken1 data_a q_b wren_a
...
module  m144k_spw_timecode_dc_fifo_altsyncram
	( 
	aclr1,
	address_a,
	address_b,
...
endmodule //m144k_spw_timecode_dc_fifo_altsyncram
...
module  m144k_spw_timecode_dc_fifo_dffpipe
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	assign
		...
		q = dffe11a,
		sclr = 1'b0;
endmodule //m144k_spw_timecode_dc_fifo_dffpipe
...
module  m144k_spw_timecode_dc_fifo_dffpipe1
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		...
		else if  (ena == 1'b1)   dffe12a <= (d & {3{(~ sclr)}});
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe12a,
		sclr = 1'b0;
endmodule //m144k_spw_timecode_dc_fifo_dffpipe1
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF"} *)
module  m144k_spw_timecode_dc_fifo_dffpipe12
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		...
		else if  (ena == 1'b1)   dffe14a <= (d & {3{(~ sclr)}});
	// synopsys translate_off
	initial
		dffe15a = 0;
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		...
		else if  (ena == 1'b1)   dffe15a <= (dffe14a & {3{(~ sclr)}});
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe15a,
		sclr = 1'b0;
endmodule //m144k_spw_timecode_dc_fifo_dffpipe12
...
module  m144k_spw_timecode_dc_fifo_alt_synch_pipe
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	wire  [2:0]   wire_dffpipe13_q;

	m144k_spw_timecode_dc_fifo_dffpipe12   dffpipe13
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe13_q;
endmodule //m144k_spw_timecode_dc_fifo_alt_synch_pipe
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF"} *)
module  m144k_spw_timecode_dc_fifo_dffpipe123
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	assign
		...
		q = dffe18a,
		sclr = 1'b0;
endmodule //m144k_spw_timecode_dc_fifo_dffpipe123
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"X_ON_VIOLATION_OPTION=OFF;SYNCHRONIZER_IDENTIFICATION=FORCED_IF_ASYNCHRONOUS;PRESERVE_REGISTER=ON;DONT_MERGE_REGISTER=ON;ADV_NETLIST_OPT_ALLOWED=NEVER_ALLOW"} *)
module  m144k_spw_timecode_dc_fifo_alt_synch_pipe1
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	m144k_spw_timecode_dc_fifo_dffpipe123   dffpipe16
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe16_q;
endmodule //m144k_spw_timecode_dc_fifo_alt_synch_pipe1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m144k_spw_timecode_dc_fifo_cmpr
	( 
	aeb,
	dataa,
...
endmodule //m144k_spw_timecode_dc_fifo_cmpr

//synthesis_resources = lut 8 M144K 1 reg 45 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF;REMOVE_DUPLICATE_REGISTERS=OFF;SYNCHRONIZER_IDENTIFICATION=OFF;SYNCHRONIZATION_REGISTER_CHAIN_LENGTH = 2;suppress_da_rule_internal=d101;suppress_da_rule_internal=d102;suppress_da_rule_internal=d103;suppress_da_rule_internal=R105;-name CUT ON -from rdptr_g -to ws_dgrp|m144k_spw_timecode_dc_fifo_dffpipe123:dffpipe16|dffe17a;-name SDC_STATEMENT \"set_false_path -from *rdptr_g* -to *ws_dgrp|m144k_spw_timecode_dc_fifo_dffpipe123:dffpipe16|dffe17a* \";-name CUT ON -from delayed_wrptr_g -to rs_dgwp|m144k_spw_timecode_dc_fifo_dffpipe12:dffpipe13|dffe14a;-name SDC_STATEMENT \"set_false_path -from *delayed_wrptr_g* -to *rs_dgwp|m144k_spw_timecode_dc_fifo_dffpipe12:dffpipe13|dffe14a* \""} *)
module  m144k_spw_timecode_dc_fifo_dcfifo
	( 
	aclr,
	data,
	q,
...
`endif
	...
	m144k_spw_timecode_dc_fifo_a_gray2bin   rdptr_g_gray2bin
	( 
	.bin(wire_rdptr_g_gray2bin_bin),
	.gray(rdptr_g[2:0]));
	m144k_spw_timecode_dc_fifo_a_gray2bin   rs_dgwp_gray2bin
	( 
	.bin(wire_rs_dgwp_gray2bin_bin),
	.gray(wire_rs_dgwp_q[2:0]));
	m144k_spw_timecode_dc_fifo_a_gray2bin   wrptr_g_gray2bin
	( 
	.bin(wire_wrptr_g_gray2bin_bin),
	.gray(wrptr_g[2:0]));
	m144k_spw_timecode_dc_fifo_a_gray2bin   ws_dgrp_gray2bin
	( 
	.bin(wire_ws_dgrp_gray2bin_bin),
	.gray(wire_ws_dgrp_q[2:0]));
	m144k_spw_timecode_dc_fifo_a_graycounter   rdptr_g1p
	( 
	.aclr((~ wire_rdaclr_q)),
	.clock(rdclk),
	.cnt_en(valid_rdreq),
	.q(wire_rdptr_g1p_q));
	m144k_spw_timecode_dc_fifo_a_graycounter1   wrptr_g1p
	( 
	.aclr((~ wire_wraclr_q)),
	.clock(wrclk),
	.cnt_en(valid_wrreq),
	.q(wire_wrptr_g1p_q));
	m144k_spw_timecode_dc_fifo_altsyncram   fifo_ram
	( 
	.aclr1((~ wire_rdaclr_q)),
	...
	m144k_spw_timecode_dc_fifo_dffpipe   rdaclr
	( 
	.clock(rdclk),
	.clrn((~ aclr)),
	.d(1'b1),
	.q(wire_rdaclr_q));
	m144k_spw_timecode_dc_fifo_dffpipe1   rs_brp
	( 
	.clock(rdclk),
	.clrn(wire_rdaclr_q),
	.d(wire_rdptr_g_gray2bin_bin),
	.q(wire_rs_brp_q));
	m144k_spw_timecode_dc_fifo_dffpipe1   rs_bwp
	( 
	.clock(rdclk),
	.clrn(wire_rdaclr_q),
	.d(wire_rs_dgwp_gray2bin_bin),
	.q(wire_rs_bwp_q));
	m144k_spw_timecode_dc_fifo_alt_synch_pipe   rs_dgwp
	( 
	.clock(rdclk),
	.clrn(wire_rdaclr_q),
	.d(delayed_wrptr_g),
	.q(wire_rs_dgwp_q));
	m144k_spw_timecode_dc_fifo_dffpipe   wraclr
	( 
	.clock(wrclk),
	.clrn((~ aclr)),
	.d(1'b1),
	.q(wire_wraclr_q));
	m144k_spw_timecode_dc_fifo_dffpipe1   ws_brp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(wire_ws_dgrp_gray2bin_bin),
	.q(wire_ws_brp_q));
	m144k_spw_timecode_dc_fifo_dffpipe1   ws_bwp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(wire_wrptr_g_gray2bin_bin),
	.q(wire_ws_bwp_q));
	m144k_spw_timecode_dc_fifo_alt_synch_pipe1   ws_dgrp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(rdptr_g),
	...
	m144k_spw_timecode_dc_fifo_cmpr   rdempty_eq_comp
	( 
	.aeb(wire_rdempty_eq_comp_aeb),
	.dataa(wire_rs_dgwp_q),
	.datab(rdptr_g));
	m144k_spw_timecode_dc_fifo_cmpr   wrfull_eq_comp
	( 
...
endmodule //m144k_spw_timecode_dc_fifo_dcfifo
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module m144k_spw_timecode_dc_fifo (
	aclr,
	data,
	rdclk,
	rdreq,
...
`endif
	...
	m144k_spw_timecode_dc_fifo_dcfifo	m144k_spw_timecode_dc_fifo_dcfifo_component (
				.aclr (aclr),
				.data (data),
				.rdclk (rdclk),
				.rdreq (rdreq),
