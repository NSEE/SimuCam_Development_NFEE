...
//synthesis_resources = ram_bits (AUTO) 56 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"OPTIMIZE_POWER_DURING_SYNTHESIS=NORMAL_COMPILATION"} *)
module  spwc_status_dc_fifo_altsyncram
	( 
	aclr1,
	address_a,
	address_b,
...
`endif
	...
	defparam
		...
		ram_block9a_0.port_a_logical_ram_width = 7,
		...
		ram_block9a_0.port_b_logical_ram_width = 7,
	...
	defparam
		...
		ram_block9a_1.port_a_logical_ram_width = 7,
		...
		ram_block9a_1.port_b_logical_ram_width = 7,
	...
	defparam
		...
		ram_block9a_2.port_a_logical_ram_width = 7,
		...
		ram_block9a_2.port_b_logical_ram_width = 7,
	...
	defparam
		...
		ram_block9a_3.port_a_logical_ram_width = 7,
		...
		ram_block9a_3.port_b_logical_ram_width = 7,
	...
	defparam
		...
		ram_block9a_4.port_a_logical_ram_width = 7,
		...
		ram_block9a_4.port_b_logical_ram_width = 7,
	...
	defparam
		...
		ram_block9a_5.port_a_logical_ram_width = 7,
		...
		ram_block9a_5.port_b_logical_ram_width = 7,
	...
	defparam
		...
		ram_block9a_6.port_a_logical_ram_width = 7,
		...
		ram_block9a_6.port_b_logical_ram_width = 7,
	...
	assign
		...
		q_b = {wire_ram_block9a_6portbdataout[0], wire_ram_block9a_5portbdataout[0], wire_ram_block9a_4portbdataout[0], wire_ram_block9a_3portbdataout[0], wire_ram_block9a_2portbdataout[0], wire_ram_block9a_1portbdataout[0], wire_ram_block9a_0portbdataout[0]};
endmodule //spwc_status_dc_fifo_altsyncram
...
`endif
	...
	spwc_status_dc_fifo_dffpipe12   dffpipe13
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
...
`endif
	...
	spwc_status_dc_fifo_dffpipe123   dffpipe16
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
...
//synthesis_resources = lut 10 ram_bits (AUTO) 56 reg 58 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF;REMOVE_DUPLICATE_REGISTERS=OFF;SYNCHRONIZER_IDENTIFICATION=OFF;SYNCHRONIZATION_REGISTER_CHAIN_LENGTH = 2;suppress_da_rule_internal=d101;suppress_da_rule_internal=d102;suppress_da_rule_internal=d103;suppress_da_rule_internal=R105;-name CUT ON -from rdptr_g -to ws_dgrp|spwc_status_dc_fifo_dffpipe123:dffpipe16|dffe17a;-name SDC_STATEMENT \"set_false_path -from *rdptr_g* -to *ws_dgrp|spwc_status_dc_fifo_dffpipe123:dffpipe16|dffe17a* \";-name CUT ON -from delayed_wrptr_g -to rs_dgwp|spwc_status_dc_fifo_dffpipe12:dffpipe13|dffe14a;-name SDC_STATEMENT \"set_false_path -from *delayed_wrptr_g* -to *rs_dgwp|spwc_status_dc_fifo_dffpipe12:dffpipe13|dffe14a* \""} *)
...
`endif
	...
	.cnt_en(valid_wrreq),
	.q(wire_wrptr_g1p_q));
	spwc_status_dc_fifo_altsyncram   fifo_ram
	( 
	.aclr1((~ wire_rdaclr_q)),
