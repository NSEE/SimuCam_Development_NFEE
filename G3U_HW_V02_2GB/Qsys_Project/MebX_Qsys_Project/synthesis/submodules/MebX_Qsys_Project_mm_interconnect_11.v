...
module MebX_Qsys_Project_mm_interconnect_11 (
		...
		input  wire         dma_comm_1_right_reset_n_reset_bridge_in_reset_reset,         //         dma_comm_1_right_reset_n_reset_bridge_in_reset.reset
		input  wire [32:0]  dma_comm_1_right_mm_write_address,                            //                              dma_comm_1_right_mm_write.address
		output wire         dma_comm_1_right_mm_write_waitrequest,                        //                                                       .waitrequest
	...
	altera_merlin_master_translator #(
	...
	) dma_comm_1_right_mm_write_translator (
		.clk                    (clk_100_clk_clk),                                                              //                       clk.clk
		.reset                  (dma_comm_1_right_reset_n_reset_bridge_in_reset_reset),                         //                     reset.reset
		.uav_address            (dma_comm_1_right_mm_write_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (dma_comm_1_right_mm_write_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (dma_comm_1_right_mm_write_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (dma_comm_1_right_mm_write_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (dma_comm_1_right_mm_write_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (dma_comm_1_right_mm_write_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (dma_comm_1_right_mm_write_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (dma_comm_1_right_mm_write_translator_avalon_universal_master_0_readdata),      //                          .readdata
		...
		.av_address             (dma_comm_1_right_mm_write_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (dma_comm_1_right_mm_write_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (dma_comm_1_right_mm_write_byteenable),                                         //                          .byteenable
		.av_write               (dma_comm_1_right_mm_write_write),                                              //                          .write
		.av_writedata           (dma_comm_1_right_mm_write_writedata),                                          //                          .writedata
