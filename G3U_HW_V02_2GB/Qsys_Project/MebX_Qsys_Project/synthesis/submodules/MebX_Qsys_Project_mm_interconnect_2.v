...
module MebX_Qsys_Project_mm_interconnect_2 (
	...
	wire  [23:0] cmd_mux_src_channel;                                                                       // cmd_mux:src_channel -> sync_avalon_mm_slave_agent:cp_channel
	...
	wire  [23:0] cmd_mux_001_src_channel;                                                                   // cmd_mux_001:src_channel -> rst_controller_avalon_rst_controller_slave_agent:cp_channel
	...
	wire  [23:0] cmd_mux_002_src_channel;                                                                   // cmd_mux_002:src_channel -> Altera_UP_SD_Card_Avalon_Interface_0_avalon_sdcard_slave_agent:cp_channel
	...
	wire  [23:0] cmd_mux_003_src_channel;                                                                   // cmd_mux_003:src_channel -> m1_ddr2_i2c_sda_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_004_src_channel;                                                                   // cmd_mux_004:src_channel -> m1_ddr2_i2c_scl_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_005_src_channel;                                                                   // cmd_mux_005:src_channel -> pio_BUTTON_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_006_src_channel;                                                                   // cmd_mux_006:src_channel -> pio_LED_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_007_src_channel;                                                                   // cmd_mux_007:src_channel -> timer_1ms_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_008_src_channel;                                                                   // cmd_mux_008:src_channel -> pio_DIP_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_009_src_channel;                                                                   // cmd_mux_009:src_channel -> timer_1us_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_010_src_channel;                                                                   // cmd_mux_010:src_channel -> pio_EXT_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_011_src_channel;                                                                   // cmd_mux_011:src_channel -> sd_card_wp_n_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_012_src_channel;                                                                   // cmd_mux_012:src_channel -> temp_scl_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_013_src_channel;                                                                   // cmd_mux_013:src_channel -> temp_sda_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_014_src_channel;                                                                   // cmd_mux_014:src_channel -> m2_ddr2_i2c_sda_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_015_src_channel;                                                                   // cmd_mux_015:src_channel -> m2_ddr2_i2c_scl_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_016_src_channel;                                                                   // cmd_mux_016:src_channel -> csense_sdo_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_017_src_channel;                                                                   // cmd_mux_017:src_channel -> csense_sdi_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_018_src_channel;                                                                   // cmd_mux_018:src_channel -> csense_sck_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_019_src_channel;                                                                   // cmd_mux_019:src_channel -> csense_cs_n_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_020_src_channel;                                                                   // cmd_mux_020:src_channel -> csense_adc_fo_s1_agent:cp_channel
	...
	wire  [23:0] cmd_mux_021_src_channel;                                                                   // cmd_mux_021:src_channel -> pio_LED_painel_s1_agent:cp_channel
	...
	wire         cmd_mux_022_src_valid;                                                                     // cmd_mux_022:src_valid -> rs232_uart_s1_agent:cp_valid
	wire  [89:0] cmd_mux_022_src_data;                                                                      // cmd_mux_022:src_data -> rs232_uart_s1_agent:cp_data
	wire         cmd_mux_022_src_ready;                                                                     // rs232_uart_s1_agent:cp_ready -> cmd_mux_022:src_ready
	wire  [23:0] cmd_mux_022_src_channel;                                                                   // cmd_mux_022:src_channel -> rs232_uart_s1_agent:cp_channel
	wire         cmd_mux_022_src_startofpacket;                                                             // cmd_mux_022:src_startofpacket -> rs232_uart_s1_agent:cp_startofpacket
	wire         cmd_mux_022_src_endofpacket;                                                               // cmd_mux_022:src_endofpacket -> rs232_uart_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_023_src_valid;                                                                     // cmd_mux_023:src_valid -> pio_ctrl_io_lvds_s1_agent:cp_valid
	wire  [89:0] cmd_mux_023_src_data;                                                                      // cmd_mux_023:src_data -> pio_ctrl_io_lvds_s1_agent:cp_data
	wire         cmd_mux_023_src_ready;                                                                     // pio_ctrl_io_lvds_s1_agent:cp_ready -> cmd_mux_023:src_ready
	wire  [23:0] cmd_mux_023_src_channel;                                                                   // cmd_mux_023:src_channel -> pio_ctrl_io_lvds_s1_agent:cp_channel
	wire         cmd_mux_023_src_startofpacket;                                                             // cmd_mux_023:src_startofpacket -> pio_ctrl_io_lvds_s1_agent:cp_startofpacket
	wire         cmd_mux_023_src_endofpacket;                                                               // cmd_mux_023:src_endofpacket -> pio_ctrl_io_lvds_s1_agent:cp_endofpacket
	...
	wire         rs232_uart_s1_agent_rp_valid;                                                              // rs232_uart_s1_agent:rp_valid -> router_023:sink_valid
	wire  [89:0] rs232_uart_s1_agent_rp_data;                                                               // rs232_uart_s1_agent:rp_data -> router_023:sink_data
	wire         rs232_uart_s1_agent_rp_ready;                                                              // router_023:sink_ready -> rs232_uart_s1_agent:rp_ready
	wire         rs232_uart_s1_agent_rp_startofpacket;                                                      // rs232_uart_s1_agent:rp_startofpacket -> router_023:sink_startofpacket
	wire         rs232_uart_s1_agent_rp_endofpacket;                                                        // rs232_uart_s1_agent:rp_endofpacket -> router_023:sink_endofpacket
	...
	wire         pio_ctrl_io_lvds_s1_agent_rp_valid;                                                        // pio_ctrl_io_lvds_s1_agent:rp_valid -> router_024:sink_valid
	wire  [89:0] pio_ctrl_io_lvds_s1_agent_rp_data;                                                         // pio_ctrl_io_lvds_s1_agent:rp_data -> router_024:sink_data
	wire         pio_ctrl_io_lvds_s1_agent_rp_ready;                                                        // router_024:sink_ready -> pio_ctrl_io_lvds_s1_agent:rp_ready
	wire         pio_ctrl_io_lvds_s1_agent_rp_startofpacket;                                                // pio_ctrl_io_lvds_s1_agent:rp_startofpacket -> router_024:sink_startofpacket
	wire         pio_ctrl_io_lvds_s1_agent_rp_endofpacket;                                                  // pio_ctrl_io_lvds_s1_agent:rp_endofpacket -> router_024:sink_endofpacket
	...
	wire         rs232_uart_s1_agent_rdata_fifo_src_valid;                                                  // rs232_uart_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_022:in_0_valid
	wire  [33:0] rs232_uart_s1_agent_rdata_fifo_src_data;                                                   // rs232_uart_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_022:in_0_data
	wire         rs232_uart_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_022:in_0_ready -> rs232_uart_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_022_out_0_valid;                                                         // avalon_st_adapter_022:out_0_valid -> rs232_uart_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_022_out_0_data;                                                          // avalon_st_adapter_022:out_0_data -> rs232_uart_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_022_out_0_ready;                                                         // rs232_uart_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_022:out_0_ready
	wire   [0:0] avalon_st_adapter_022_out_0_error;                                                         // avalon_st_adapter_022:out_0_error -> rs232_uart_s1_agent:rdata_fifo_sink_error
	wire         pio_ctrl_io_lvds_s1_agent_rdata_fifo_src_valid;                                            // pio_ctrl_io_lvds_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_023:in_0_valid
	wire  [33:0] pio_ctrl_io_lvds_s1_agent_rdata_fifo_src_data;                                             // pio_ctrl_io_lvds_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_023:in_0_data
	wire         pio_ctrl_io_lvds_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_023:in_0_ready -> pio_ctrl_io_lvds_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_023_out_0_valid;                                                         // avalon_st_adapter_023:out_0_valid -> pio_ctrl_io_lvds_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_023_out_0_data;                                                          // avalon_st_adapter_023:out_0_data -> pio_ctrl_io_lvds_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_023_out_0_ready;                                                         // pio_ctrl_io_lvds_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_023:out_0_ready
	wire   [0:0] avalon_st_adapter_023_out_0_error;                                                         // avalon_st_adapter_023:out_0_error -> pio_ctrl_io_lvds_s1_agent:rdata_fifo_sink_error
