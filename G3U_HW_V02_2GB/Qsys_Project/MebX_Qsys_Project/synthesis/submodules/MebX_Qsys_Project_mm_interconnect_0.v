...
module MebX_Qsys_Project_mm_interconnect_0 (
	...
	wire          cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> af_100i_mm_clock_crossing_bridge_s0_agent:cp_valid
	wire  [113:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> af_100i_mm_clock_crossing_bridge_s0_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // af_100i_mm_clock_crossing_bridge_s0_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> af_100i_mm_clock_crossing_bridge_s0_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> af_100i_mm_clock_crossing_bridge_s0_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> af_100i_mm_clock_crossing_bridge_s0_agent:cp_endofpacket
	...
	wire          af_100i_mm_clock_crossing_bridge_s0_agent_rp_valid;                                 // af_100i_mm_clock_crossing_bridge_s0_agent:rp_valid -> router_004:sink_valid
	wire  [113:0] af_100i_mm_clock_crossing_bridge_s0_agent_rp_data;                                  // af_100i_mm_clock_crossing_bridge_s0_agent:rp_data -> router_004:sink_data
	wire          af_100i_mm_clock_crossing_bridge_s0_agent_rp_ready;                                 // router_004:sink_ready -> af_100i_mm_clock_crossing_bridge_s0_agent:rp_ready
	wire          af_100i_mm_clock_crossing_bridge_s0_agent_rp_startofpacket;                         // af_100i_mm_clock_crossing_bridge_s0_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          af_100i_mm_clock_crossing_bridge_s0_agent_rp_endofpacket;                           // af_100i_mm_clock_crossing_bridge_s0_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [113:0] onchip_memory_s1_agent_rp_data;                                                     // onchip_memory_s1_agent:rp_data -> router_005:sink_data
	...
	wire          ext_flash_uas_agent_rp_valid;                                                       // ext_flash_uas_agent:rp_valid -> router_006:sink_valid
	wire   [95:0] ext_flash_uas_agent_rp_data;                                                        // ext_flash_uas_agent:rp_data -> router_006:sink_data
	wire          ext_flash_uas_agent_rp_ready;                                                       // router_006:sink_ready -> ext_flash_uas_agent:rp_ready
	wire          ext_flash_uas_agent_rp_startofpacket;                                               // ext_flash_uas_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          ext_flash_uas_agent_rp_endofpacket;                                                 // ext_flash_uas_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire    [4:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> nios2_gen2_0_debug_mem_slave_burst_adapter:sink0_channel
	...
	wire  [113:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_memory_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                              // onchip_memory_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> onchip_memory_s1_burst_adapter:sink0_channel
	...
	wire    [4:0] ext_flash_uas_burst_adapter_source0_channel;                                        // ext_flash_uas_burst_adapter:source0_channel -> ext_flash_uas_agent:cp_channel
	...
	wire  [113:0] cmd_demux_001_src1_data;                                                            // cmd_demux_001:src1_data -> cmd_mux_003:sink1_data
	...
	wire  [113:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> cmd_mux_004:sink1_data
	...
	wire  [113:0] rsp_demux_003_src1_data;                                                            // rsp_demux_003:src1_data -> rsp_mux_001:sink1_data
	...
	wire  [113:0] rsp_demux_004_src1_data;                                                            // rsp_demux_004:src1_data -> rsp_mux_001:sink2_data
	...
	wire          router_006_src_valid;                                                               // router_006:src_valid -> ext_flash_uas_rsp_width_adapter:in_valid
	wire   [95:0] router_006_src_data;                                                                // router_006:src_data -> ext_flash_uas_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                               // ext_flash_uas_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [4:0] router_006_src_channel;                                                             // router_006:src_channel -> ext_flash_uas_rsp_width_adapter:in_channel
	wire          router_006_src_startofpacket;                                                       // router_006:src_startofpacket -> ext_flash_uas_rsp_width_adapter:in_startofpacket
	wire          router_006_src_endofpacket;                                                         // router_006:src_endofpacket -> ext_flash_uas_rsp_width_adapter:in_endofpacket
	wire          ext_flash_uas_rsp_width_adapter_src_valid;                                          // ext_flash_uas_rsp_width_adapter:out_valid -> rsp_demux_004:sink_valid
	wire  [113:0] ext_flash_uas_rsp_width_adapter_src_data;                                           // ext_flash_uas_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          ext_flash_uas_rsp_width_adapter_src_ready;                                          // rsp_demux_004:sink_ready -> ext_flash_uas_rsp_width_adapter:out_ready
	wire    [4:0] ext_flash_uas_rsp_width_adapter_src_channel;                                        // ext_flash_uas_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	wire          ext_flash_uas_rsp_width_adapter_src_startofpacket;                                  // ext_flash_uas_rsp_width_adapter:out_startofpacket -> rsp_demux_004:sink_startofpacket
	wire          ext_flash_uas_rsp_width_adapter_src_endofpacket;                                    // ext_flash_uas_rsp_width_adapter:out_endofpacket -> rsp_demux_004:sink_endofpacket
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> ext_flash_uas_cmd_width_adapter:in_valid
	wire  [113:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> ext_flash_uas_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                              // ext_flash_uas_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> ext_flash_uas_cmd_width_adapter:in_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> ext_flash_uas_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> ext_flash_uas_cmd_width_adapter:in_endofpacket
	...
	wire    [4:0] ext_flash_uas_cmd_width_adapter_src_channel;                                        // ext_flash_uas_cmd_width_adapter:out_channel -> ext_flash_uas_burst_adapter:sink0_channel
	...
	wire          af_100i_mm_clock_crossing_bridge_s0_agent_rdata_fifo_src_valid;                     // af_100i_mm_clock_crossing_bridge_s0_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] af_100i_mm_clock_crossing_bridge_s0_agent_rdata_fifo_src_data;                      // af_100i_mm_clock_crossing_bridge_s0_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          af_100i_mm_clock_crossing_bridge_s0_agent_rdata_fifo_src_ready;                     // avalon_st_adapter_002:in_0_ready -> af_100i_mm_clock_crossing_bridge_s0_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> af_100i_mm_clock_crossing_bridge_s0_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> af_100i_mm_clock_crossing_bridge_s0_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                                  // af_100i_mm_clock_crossing_bridge_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> af_100i_mm_clock_crossing_bridge_s0_agent:rdata_fifo_sink_error
	...
	wire          ext_flash_uas_agent_rdata_fifo_out_valid;                                           // ext_flash_uas_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [17:0] ext_flash_uas_agent_rdata_fifo_out_data;                                            // ext_flash_uas_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          ext_flash_uas_agent_rdata_fifo_out_ready;                                           // avalon_st_adapter_004:in_0_ready -> ext_flash_uas_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> ext_flash_uas_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> ext_flash_uas_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // ext_flash_uas_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> ext_flash_uas_agent:rdata_fifo_sink_error
	...
	MebX_Qsys_Project_mm_interconnect_0_router_003 router_005 (
	...
	MebX_Qsys_Project_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_200_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MebX_Qsys_Project_mm_interconnect_0_avalon_st_adapter_004 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
