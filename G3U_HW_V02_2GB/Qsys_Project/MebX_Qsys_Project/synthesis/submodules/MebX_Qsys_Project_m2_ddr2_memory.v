// MebX_Qsys_Project_m2_ddr2_memory.v
...
`timescale 1 ps / 1 ps
module MebX_Qsys_Project_m2_ddr2_memory (
		...
		output wire [5:0]   dll_delayctrl              //                 .dll_delayctrl
	);
	...
	MebX_Qsys_Project_m2_ddr2_memory_pll0 pll0 (
	...
	MebX_Qsys_Project_m2_ddr2_memory_p0 p0 (
		.global_reset_n              (global_reset_n),                              //        global_reset.reset_n
	...
	MebX_Qsys_Project_m2_ddr2_memory_s0 s0 (
		.avl_clk                     (p0_avl_clk_clk),                     //          avl_clk.clk
		.avl_reset_n                 (p0_avl_reset_reset),                 //        avl_reset.reset_n
		.scc_clk                     (p0_scc_clk_clk),                     //          scc_clk.clk
	...
	MebX_Qsys_Project_m1_ddr2_memory_c0 c0 (
		.afi_reset_n         (afi_reset_n),                //    afi_reset.reset_n
		.afi_clk             (afi_clk),                    //      afi_clk.clk
		.afi_half_clk        (afi_half_clk),               // afi_half_clk.clk
