...
// ============================================================
// File Name: m144k_scfifo_data_buffer.v
// Megafunction Name(s):
// 			scfifo
//
...
module  m144k_scfifo_data_buffer_decode
	( 
	data,
	enable,
...
endmodule //m144k_scfifo_data_buffer_decode
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m144k_scfifo_data_buffer_mux
	( 
	data,
	result,
...
`endif
	...
	assign
		...
		sel_wire = {sel[0]};
endmodule //m144k_scfifo_data_buffer_mux

//synthesis_resources = lut 5 M144K 2 reg 2 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"OPTIMIZE_POWER_DURING_SYNTHESIS=NORMAL_COMPILATION"} *)
module  m144k_scfifo_data_buffer_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
`endif
	...
	m144k_scfifo_data_buffer_decode   decode2
	( 
	.data(address_a_wire[14]),
	.enable(wren_a),
	.eq(wire_decode2_eq));
	m144k_scfifo_data_buffer_decode   wren_decode_a
	( 
	.data(w_addr_val_a343w),
	.enable(wren_a),
	.eq(wire_wren_decode_a_eq));
	m144k_scfifo_data_buffer_mux   mux3
	( 
...
endmodule //m144k_scfifo_data_buffer_altsyncram
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m144k_scfifo_data_buffer_cmpr
	( 
	aeb,
	dataa,
...
endmodule //m144k_scfifo_data_buffer_cmpr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m144k_scfifo_data_buffer_cntr
	( 
	aclr,
	clock,
	cnt_en,
...
endmodule //m144k_scfifo_data_buffer_cntr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m144k_scfifo_data_buffer_cntr1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //m144k_scfifo_data_buffer_cntr1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m144k_scfifo_data_buffer_cntr12
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //m144k_scfifo_data_buffer_cntr12

//synthesis_resources = lut 49 M144K 2 reg 67 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m144k_scfifo_data_buffer_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	m144k_scfifo_data_buffer_altsyncram   FIFOram
	( 
	...
	.q(wire_rd_ptr_msb_q),
	.sclr(sclr));
	m144k_scfifo_data_buffer_cntr1   usedw_counter
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.sclr(sclr),
	.updown(valid_wreq));
	m144k_scfifo_data_buffer_cntr12   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
...
endmodule //m144k_scfifo_data_buffer_a_dpfifo

//synthesis_resources = lut 49 M144K 2 reg 69 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  m144k_scfifo_data_buffer_scfifo
	( 
	aclr,
	almost_empty,
	almost_full,
...
`endif
	...
	m144k_scfifo_data_buffer_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
...
endmodule //m144k_scfifo_data_buffer_scfifo
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module m144k_scfifo_data_buffer (
	aclr,
	clock,
	data,
	rdreq,
	...
	m144k_scfifo_data_buffer_scfifo	m144k_scfifo_data_buffer_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
