...
// ============================================================
// File Name: mlab_masking_machine_sc_fifo.v
// Megafunction Name(s):
// 			scfifo
//
...
module  mlab_masking_machine_sc_fifo_cntr
	( 
	aclr,
	clock,
	cnt_en,
...
endmodule //mlab_masking_machine_sc_fifo_cntr

//synthesis_resources = lut 8 reg 10 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_masking_machine_sc_fifo_a_fefifo
	( 
	aclr,
	clock,
	empty,
...
`endif
	...
	mlab_masking_machine_sc_fifo_cntr   count_usedw
	( 
	.aclr(aclr),
	.clock(clock),
...
endmodule //mlab_masking_machine_sc_fifo_a_fefifo
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_masking_machine_sc_fifo_decode
	( 
	data,
	enable,
...
endmodule //mlab_masking_machine_sc_fifo_decode
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_masking_machine_sc_fifo_mux
	( 
	data,
	result,
...
endmodule //mlab_masking_machine_sc_fifo_mux
...
module  mlab_masking_machine_sc_fifo_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
`endif
	...
	mlab_masking_machine_sc_fifo_decode   wr_decode
	( 
	.data(address_a[7:6]),
	.enable(wr_en),
	.eq(wire_wr_decode_eq));
	mlab_masking_machine_sc_fifo_mux   rd_mux
	( 
...
endmodule //mlab_masking_machine_sc_fifo_altsyncram
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_masking_machine_sc_fifo_cntr1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //mlab_masking_machine_sc_fifo_cntr1

//synthesis_resources = lut 36 MLAB 4 reg 50 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_masking_machine_sc_fifo_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	mlab_masking_machine_sc_fifo_a_fefifo   fifo_state
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.wreq(wreq));
	mlab_masking_machine_sc_fifo_altsyncram   FIFOram
	( 
	...
	.wren_a(valid_wreq));
	mlab_masking_machine_sc_fifo_cntr1   rd_ptr_count
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_rreq),
	...
	.sclr(sclr));
	mlab_masking_machine_sc_fifo_cntr1   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
...
endmodule //mlab_masking_machine_sc_fifo_a_dpfifo

//synthesis_resources = lut 36 MLAB 4 reg 50 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_masking_machine_sc_fifo_scfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	mlab_masking_machine_sc_fifo_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
	...
	assign
		...
		q = wire_dpfifo_q,
		usedw = wire_dpfifo_usedw;
endmodule //mlab_masking_machine_sc_fifo_scfifo
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module mlab_masking_machine_sc_fifo (
	aclr,
	clock,
	data,
	rdreq,
	...
	mlab_masking_machine_sc_fifo_scfifo	mlab_masking_machine_sc_fifo_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
