...
// ============================================================
// File Name: mlab_windowing_mask_sc_fifo.v
// Megafunction Name(s):
// 			scfifo
//
...
module  mlab_windowing_mask_sc_fifo_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
endmodule //mlab_windowing_mask_sc_fifo_altsyncram
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_windowing_mask_sc_fifo_cmpr
	( 
	aeb,
	dataa,
...
endmodule //mlab_windowing_mask_sc_fifo_cmpr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_windowing_mask_sc_fifo_cntr
	( 
	aclr,
	clock,
	cnt_en,
...
endmodule //mlab_windowing_mask_sc_fifo_cntr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_windowing_mask_sc_fifo_cntr1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //mlab_windowing_mask_sc_fifo_cntr1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_windowing_mask_sc_fifo_cntr12
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //mlab_windowing_mask_sc_fifo_cntr12

//synthesis_resources = lut 11 MLAB 4 reg 159 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_windowing_mask_sc_fifo_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	mlab_windowing_mask_sc_fifo_altsyncram   FIFOram
	( 
	...
	mlab_windowing_mask_sc_fifo_cmpr   almost_full_comparer
	( 
	.aeb(wire_almost_full_comparer_aeb),
	.dataa({4{1'b1}}),
	.datab(wire_usedw_counter_q));
	mlab_windowing_mask_sc_fifo_cmpr   three_comparison
	( 
	.aeb(wire_three_comparison_aeb),
	.dataa(wire_usedw_counter_q),
	.datab(4'b0011));
	mlab_windowing_mask_sc_fifo_cntr   rd_ptr_msb
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.q(wire_rd_ptr_msb_q),
	.sclr(sclr));
	mlab_windowing_mask_sc_fifo_cntr1   usedw_counter
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.sclr(sclr),
	.updown(valid_wreq));
	mlab_windowing_mask_sc_fifo_cntr12   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
...
endmodule //mlab_windowing_mask_sc_fifo_a_dpfifo

//synthesis_resources = lut 11 MLAB 4 reg 159 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_windowing_mask_sc_fifo_scfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	mlab_windowing_mask_sc_fifo_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
	...
	assign
		...
		q = wire_dpfifo_q,
		usedw = wire_dpfifo_usedw;
endmodule //mlab_windowing_mask_sc_fifo_scfifo
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module mlab_windowing_mask_sc_fifo (
	aclr,
	clock,
	data,
	rdreq,
	...
	mlab_windowing_mask_sc_fifo_scfifo	mlab_windowing_mask_sc_fifo_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
