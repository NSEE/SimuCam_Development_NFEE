// MebX_Qsys_Project_Burst_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module MebX_Qsys_Project_Burst_mm_interconnect_1 (
		...
		input  wire [5:0]  clock_bridge_afi_50_m0_address,                           //                             clock_bridge_afi_50_m0.address
	...
	wire   [5:0] clock_bridge_afi_50_m0_translator_avalon_universal_master_0_address;       // clock_bridge_afi_50_m0_translator:uav_address -> clock_bridge_afi_50_m0_agent:av_address
	...
	wire   [5:0] timer_1ms_s1_agent_m0_address;                                             // timer_1ms_s1_agent:m0_address -> timer_1ms_s1_translator:uav_address
	...
	wire  [76:0] timer_1ms_s1_agent_rf_source_data;                                         // timer_1ms_s1_agent:rf_source_data -> timer_1ms_s1_agent_rsp_fifo:in_data
	...
	wire  [76:0] timer_1ms_s1_agent_rsp_fifo_out_data;                                      // timer_1ms_s1_agent_rsp_fifo:out_data -> timer_1ms_s1_agent:rf_sink_data
	...
	wire         cmd_mux_src_valid;                                                         // cmd_mux:src_valid -> timer_1ms_s1_agent:cp_valid
	wire  [75:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> timer_1ms_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                         // timer_1ms_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> timer_1ms_s1_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                 // cmd_mux:src_startofpacket -> timer_1ms_s1_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                   // cmd_mux:src_endofpacket -> timer_1ms_s1_agent:cp_endofpacket
	...
	wire   [5:0] timer_1us_s1_agent_m0_address;                                             // timer_1us_s1_agent:m0_address -> timer_1us_s1_translator:uav_address
	...
	wire  [76:0] timer_1us_s1_agent_rf_source_data;                                         // timer_1us_s1_agent:rf_source_data -> timer_1us_s1_agent_rsp_fifo:in_data
	...
	wire  [76:0] timer_1us_s1_agent_rsp_fifo_out_data;                                      // timer_1us_s1_agent_rsp_fifo:out_data -> timer_1us_s1_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                     // cmd_mux_001:src_valid -> timer_1us_s1_agent:cp_valid
	wire  [75:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> timer_1us_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                     // timer_1us_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [1:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> timer_1us_s1_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                             // cmd_mux_001:src_startofpacket -> timer_1us_s1_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                               // cmd_mux_001:src_endofpacket -> timer_1us_s1_agent:cp_endofpacket
	wire         clock_bridge_afi_50_m0_agent_cp_valid;                                     // clock_bridge_afi_50_m0_agent:cp_valid -> router:sink_valid
	wire  [75:0] clock_bridge_afi_50_m0_agent_cp_data;                                      // clock_bridge_afi_50_m0_agent:cp_data -> router:sink_data
	...
	wire         timer_1ms_s1_agent_rp_valid;                                               // timer_1ms_s1_agent:rp_valid -> router_001:sink_valid
	wire  [75:0] timer_1ms_s1_agent_rp_data;                                                // timer_1ms_s1_agent:rp_data -> router_001:sink_data
	wire         timer_1ms_s1_agent_rp_ready;                                               // router_001:sink_ready -> timer_1ms_s1_agent:rp_ready
	wire         timer_1ms_s1_agent_rp_startofpacket;                                       // timer_1ms_s1_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire         timer_1ms_s1_agent_rp_endofpacket;                                         // timer_1ms_s1_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire         timer_1us_s1_agent_rp_valid;                                               // timer_1us_s1_agent:rp_valid -> router_002:sink_valid
	wire  [75:0] timer_1us_s1_agent_rp_data;                                                // timer_1us_s1_agent:rp_data -> router_002:sink_data
	wire         timer_1us_s1_agent_rp_ready;                                               // router_002:sink_ready -> timer_1us_s1_agent:rp_ready
	wire         timer_1us_s1_agent_rp_startofpacket;                                       // timer_1us_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         timer_1us_s1_agent_rp_endofpacket;                                         // timer_1us_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [75:0] router_src_data;                                                           // router:src_data -> clock_bridge_afi_50_m0_limiter:cmd_sink_data
	wire         router_src_ready;                                                          // clock_bridge_afi_50_m0_limiter:cmd_sink_ready -> router:src_ready
	wire   [1:0] router_src_channel;                                                        // router:src_channel -> clock_bridge_afi_50_m0_limiter:cmd_sink_channel
	...
	wire  [75:0] clock_bridge_afi_50_m0_limiter_cmd_src_data;                               // clock_bridge_afi_50_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         clock_bridge_afi_50_m0_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> clock_bridge_afi_50_m0_limiter:cmd_src_ready
	wire   [1:0] clock_bridge_afi_50_m0_limiter_cmd_src_channel;                            // clock_bridge_afi_50_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [75:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> clock_bridge_afi_50_m0_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                         // clock_bridge_afi_50_m0_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [1:0] rsp_mux_src_channel;                                                       // rsp_mux:src_channel -> clock_bridge_afi_50_m0_limiter:rsp_sink_channel
	...
	wire  [75:0] clock_bridge_afi_50_m0_limiter_rsp_src_data;                               // clock_bridge_afi_50_m0_limiter:rsp_src_data -> clock_bridge_afi_50_m0_agent:rp_data
	...
	wire   [1:0] clock_bridge_afi_50_m0_limiter_rsp_src_channel;                            // clock_bridge_afi_50_m0_limiter:rsp_src_channel -> clock_bridge_afi_50_m0_agent:rp_channel
	...
	wire   [1:0] clock_bridge_afi_50_m0_limiter_cmd_valid_data;                             // clock_bridge_afi_50_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire         timer_1ms_s1_agent_rdata_fifo_src_valid;                                   // timer_1ms_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] timer_1ms_s1_agent_rdata_fifo_src_data;                                    // timer_1ms_s1_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         timer_1ms_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter:in_0_ready -> timer_1ms_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                             // avalon_st_adapter:out_0_valid -> timer_1ms_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                              // avalon_st_adapter:out_0_data -> timer_1ms_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                             // timer_1ms_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                             // avalon_st_adapter:out_0_error -> timer_1ms_s1_agent:rdata_fifo_sink_error
	wire         timer_1us_s1_agent_rdata_fifo_src_valid;                                   // timer_1us_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] timer_1us_s1_agent_rdata_fifo_src_data;                                    // timer_1us_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         timer_1us_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_001:in_0_ready -> timer_1us_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                         // avalon_st_adapter_001:out_0_valid -> timer_1us_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                          // avalon_st_adapter_001:out_0_data -> timer_1us_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                         // timer_1us_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                         // avalon_st_adapter_001:out_0_error -> timer_1us_s1_agent:rdata_fifo_sink_error
	...
	MebX_Qsys_Project_Burst_mm_interconnect_1_router router (
	...
	MebX_Qsys_Project_Burst_mm_interconnect_1_router_001 router_001 (
	...
	MebX_Qsys_Project_Burst_mm_interconnect_1_router_001 router_002 (
	...
	MebX_Qsys_Project_Burst_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_50_clk_clk),                                           //        clk.clk
		.reset              (clock_bridge_afi_50_m0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	MebX_Qsys_Project_Burst_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_50_clk_clk),                                           //       clk.clk
		.reset               (clock_bridge_afi_50_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MebX_Qsys_Project_Burst_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clk_50_clk_clk),                                           //       clk.clk
		.reset               (clock_bridge_afi_50_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MebX_Qsys_Project_Burst_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_50_clk_clk),                                           //       clk.clk
		.reset              (clock_bridge_afi_50_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MebX_Qsys_Project_Burst_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (clk_50_clk_clk),                                           //       clk.clk
		.reset              (clock_bridge_afi_50_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MebX_Qsys_Project_Burst_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_50_clk_clk),                                           //       clk.clk
		.reset               (clock_bridge_afi_50_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
