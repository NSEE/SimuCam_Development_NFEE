...
// ============================================================
// File Name: spwr_dvriso_en_out_altiobuf.v
// Megafunction Name(s):
// 			altiobuf_out
//
...
module  spwr_dvriso_en_out_altiobuf_iobuf_out
	( 
	datain,
	...
	assign
		...
		oe_w = 1'b1;
endmodule //spwr_dvriso_en_out_altiobuf_iobuf_out
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module spwr_dvriso_en_out_altiobuf (
	datain,
	dataout)/* synthesis synthesis_clearbox = 1 */;
	...
	spwr_dvriso_en_out_altiobuf_iobuf_out	spwr_dvriso_en_out_altiobuf_iobuf_out_component (
				.datain (datain),
				.dataout (sub_wire0));
