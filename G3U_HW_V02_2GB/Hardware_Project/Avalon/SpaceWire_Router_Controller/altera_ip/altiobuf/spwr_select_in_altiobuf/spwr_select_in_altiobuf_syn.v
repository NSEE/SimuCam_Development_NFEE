...
// ============================================================
// File Name: spwr_select_in_altiobuf.v
// Megafunction Name(s):
// 			altiobuf_in
//
...
//altiobuf_in DEVICE_FAMILY="Stratix IV" ENABLE_BUS_HOLD="FALSE" NUMBER_OF_CHANNELS=2 USE_DIFFERENTIAL_MODE="FALSE" USE_DYNAMIC_TERMINATION_CONTROL="FALSE" datain dataout
...
module  spwr_select_in_altiobuf_iobuf_in
	( 
	datain,
...
endmodule //spwr_select_in_altiobuf_iobuf_in
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module spwr_select_in_altiobuf (
	datain,
	dataout)/* synthesis synthesis_clearbox = 1 */;
	...
	spwr_select_in_altiobuf_iobuf_in	spwr_select_in_altiobuf_iobuf_in_component (
				.datain (datain),
				.dataout (sub_wire0));
