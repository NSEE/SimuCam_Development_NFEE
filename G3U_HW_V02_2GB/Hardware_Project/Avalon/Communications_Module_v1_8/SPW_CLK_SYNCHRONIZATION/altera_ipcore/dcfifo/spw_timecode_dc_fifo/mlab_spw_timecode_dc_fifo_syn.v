...
// ============================================================
// File Name: mlab_spw_timecode_dc_fifo.v
// Megafunction Name(s):
// 			dcfifo
//
...
module  mlab_spw_timecode_dc_fifo_a_gray2bin
	( 
	bin,
	...
	assign
		...
		xor0 = (gray[0] ^ xor1),
		xor1 = (gray[2] ^ gray[1]);
endmodule //mlab_spw_timecode_dc_fifo_a_gray2bin
...
module  mlab_spw_timecode_dc_fifo_a_graycounter
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		sclr = 1'b0,
		updown = 1'b1;
endmodule //mlab_spw_timecode_dc_fifo_a_graycounter
...
module  mlab_spw_timecode_dc_fifo_a_graycounter1
	( 
	aclr,
	clock,
	cnt_en,
...
module  mlab_spw_timecode_dc_fifo_dpram
	( 
	aclr,
	data,
	inclock,
...
endmodule //mlab_spw_timecode_dc_fifo_dpram
...
module  mlab_spw_timecode_dc_fifo_dffpipe
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	assign
		...
		q = dffe10a,
		sclr = 1'b0;
endmodule //mlab_spw_timecode_dc_fifo_dffpipe
...
module  mlab_spw_timecode_dc_fifo_dffpipe1
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	assign
		...
		q = dffe11a,
		sclr = 1'b0;
endmodule //mlab_spw_timecode_dc_fifo_dffpipe1
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF"} *)
module  mlab_spw_timecode_dc_fifo_dffpipe12
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	assign
		...
		q = dffe14a,
		sclr = 1'b0;
endmodule //mlab_spw_timecode_dc_fifo_dffpipe12
...
module  mlab_spw_timecode_dc_fifo_alt_synch_pipe
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	mlab_spw_timecode_dc_fifo_dffpipe12   dffpipe12
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe12_q;
endmodule //mlab_spw_timecode_dc_fifo_alt_synch_pipe
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF"} *)
module  mlab_spw_timecode_dc_fifo_dffpipe123
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	assign
		...
		q = dffe17a,
		sclr = 1'b0;
endmodule //mlab_spw_timecode_dc_fifo_dffpipe123
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"X_ON_VIOLATION_OPTION=OFF;SYNCHRONIZER_IDENTIFICATION=FORCED_IF_ASYNCHRONOUS;PRESERVE_REGISTER=ON;DONT_MERGE_REGISTER=ON;ADV_NETLIST_OPT_ALLOWED=NEVER_ALLOW"} *)
module  mlab_spw_timecode_dc_fifo_alt_synch_pipe1
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	mlab_spw_timecode_dc_fifo_dffpipe123   dffpipe15
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe15_q;
endmodule //mlab_spw_timecode_dc_fifo_alt_synch_pipe1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_spw_timecode_dc_fifo_cmpr
	( 
	aeb,
	dataa,
...
endmodule //mlab_spw_timecode_dc_fifo_cmpr

//synthesis_resources = lut 8 MLAB 1 reg 64 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF;REMOVE_DUPLICATE_REGISTERS=OFF;SYNCHRONIZER_IDENTIFICATION=OFF;SYNCHRONIZATION_REGISTER_CHAIN_LENGTH = 2;suppress_da_rule_internal=d101;suppress_da_rule_internal=d102;suppress_da_rule_internal=d103;suppress_da_rule_internal=R105;-name CUT ON -from rdptr_g -to ws_dgrp|mlab_spw_timecode_dc_fifo_dffpipe123:dffpipe15|dffe16a;-name SDC_STATEMENT \"set_false_path -from *rdptr_g* -to *ws_dgrp|mlab_spw_timecode_dc_fifo_dffpipe123:dffpipe15|dffe16a* \";-name CUT ON -from delayed_wrptr_g -to rs_dgwp|mlab_spw_timecode_dc_fifo_dffpipe12:dffpipe12|dffe13a;-name SDC_STATEMENT \"set_false_path -from *delayed_wrptr_g* -to *rs_dgwp|mlab_spw_timecode_dc_fifo_dffpipe12:dffpipe12|dffe13a* \""} *)
module  mlab_spw_timecode_dc_fifo_dcfifo
	( 
	aclr,
	data,
	q,
...
`endif
	...
	mlab_spw_timecode_dc_fifo_a_gray2bin   rdptr_g_gray2bin
	( 
	.bin(wire_rdptr_g_gray2bin_bin),
	.gray(rdptr_g[2:0]));
	mlab_spw_timecode_dc_fifo_a_gray2bin   rs_dgwp_gray2bin
	( 
	.bin(wire_rs_dgwp_gray2bin_bin),
	.gray(wire_rs_dgwp_q[2:0]));
	mlab_spw_timecode_dc_fifo_a_gray2bin   wrptr_g_gray2bin
	( 
	.bin(wire_wrptr_g_gray2bin_bin),
	.gray(wrptr_g[2:0]));
	mlab_spw_timecode_dc_fifo_a_gray2bin   ws_dgrp_gray2bin
	( 
	.bin(wire_ws_dgrp_gray2bin_bin),
	.gray(wire_ws_dgrp_q[2:0]));
	mlab_spw_timecode_dc_fifo_a_graycounter   rdptr_g1p
	( 
	.aclr((~ wire_rdaclr_q)),
	.clock(rdclk),
	.cnt_en(valid_rdreq),
	.q(wire_rdptr_g1p_q));
	mlab_spw_timecode_dc_fifo_a_graycounter1   wrptr_g1p
	( 
	.aclr((~ wire_wraclr_q)),
	.clock(wrclk),
	.cnt_en(valid_wrreq),
	.q(wire_wrptr_g1p_q));
	mlab_spw_timecode_dc_fifo_dpram   fifo_lutram
	( 
	.aclr((~ wire_rdaclr_q)),
	.data(data),
	.inclock(wrclk),
	.outclock(rdclk),
	.outclocken(valid_rdreq),
	...
	mlab_spw_timecode_dc_fifo_dffpipe   rdaclr
	( 
	.clock(rdclk),
	.clrn((~ aclr)),
	.d(1'b1),
	.q(wire_rdaclr_q));
	mlab_spw_timecode_dc_fifo_dffpipe1   rs_brp
	( 
	.clock(rdclk),
	.clrn(wire_rdaclr_q),
	.d(wire_rdptr_g_gray2bin_bin),
	.q(wire_rs_brp_q));
	mlab_spw_timecode_dc_fifo_dffpipe1   rs_bwp
	( 
	.clock(rdclk),
	.clrn(wire_rdaclr_q),
	.d(wire_rs_dgwp_gray2bin_bin),
	.q(wire_rs_bwp_q));
	mlab_spw_timecode_dc_fifo_alt_synch_pipe   rs_dgwp
	( 
	.clock(rdclk),
	.clrn(wire_rdaclr_q),
	.d(delayed_wrptr_g),
	.q(wire_rs_dgwp_q));
	mlab_spw_timecode_dc_fifo_dffpipe   wraclr
	( 
	.clock(wrclk),
	.clrn((~ aclr)),
	.d(1'b1),
	.q(wire_wraclr_q));
	mlab_spw_timecode_dc_fifo_dffpipe1   ws_brp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(wire_ws_dgrp_gray2bin_bin),
	.q(wire_ws_brp_q));
	mlab_spw_timecode_dc_fifo_dffpipe1   ws_bwp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(wire_wrptr_g_gray2bin_bin),
	.q(wire_ws_bwp_q));
	mlab_spw_timecode_dc_fifo_alt_synch_pipe1   ws_dgrp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(rdptr_g),
	...
	mlab_spw_timecode_dc_fifo_cmpr   rdempty_eq_comp
	( 
	.aeb(wire_rdempty_eq_comp_aeb),
	.dataa(wire_rs_dgwp_q),
	.datab(rdptr_g));
	mlab_spw_timecode_dc_fifo_cmpr   wrfull_eq_comp
	( 
...
endmodule //mlab_spw_timecode_dc_fifo_dcfifo
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module mlab_spw_timecode_dc_fifo (
	aclr,
	data,
	rdclk,
	rdreq,
...
`endif
	...
	mlab_spw_timecode_dc_fifo_dcfifo	mlab_spw_timecode_dc_fifo_dcfifo_component (
				.aclr (aclr),
				.data (data),
				.rdclk (rdclk),
				.rdreq (rdreq),
