...
// ============================================================
// File Name: mlab_windowing_data_sc_fifo.v
// Megafunction Name(s):
// 			scfifo
//
...
module  mlab_windowing_data_sc_fifo_decode
	( 
	data,
	enable,
...
`endif
	...
	wire  [3:0]  eq_node;
	wire  [3:0]  eq_wire;
	wire  [2:0]  w_anode406w;
	wire  [2:0]  w_anode419w;
	wire  [2:0]  w_anode427w;
	...
	assign
		...
		eq = eq_node,
		eq_node = eq_wire[3:0],
		eq_wire = {w_anode435w[2], w_anode427w[2], w_anode419w[2], w_anode406w[2]},
		w_anode406w = {(w_anode406w[1] & (~ data_wire[1])), (w_anode406w[0] & (~ data_wire[0])), enable_wire},
		w_anode419w = {(w_anode419w[1] & (~ data_wire[1])), (w_anode419w[0] & data_wire[0]), enable_wire},
		w_anode427w = {(w_anode427w[1] & data_wire[1]), (w_anode427w[0] & (~ data_wire[0])), enable_wire},
		w_anode435w = {(w_anode435w[1] & data_wire[1]), (w_anode435w[0] & data_wire[0]), enable_wire};
endmodule //mlab_windowing_data_sc_fifo_decode
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_windowing_data_sc_fifo_mux
	( 
	data,
	result,
...
endmodule //mlab_windowing_data_sc_fifo_mux

//synthesis_resources = lut 68 MLAB 26 reg 144 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"ADV_NETLIST_OPT_ALLOWED=\"NEVER_ALLOW\";OPTIMIZE_POWER_DURING_SYNTHESIS=NORMAL_COMPILATION"} *)
module  mlab_windowing_data_sc_fifo_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
`endif
	...
	mlab_windowing_data_sc_fifo_decode   wr_decode
	( 
	.data(address_a[7:6]),
	.enable(wr_en),
	.eq(wire_wr_decode_eq));
	mlab_windowing_data_sc_fifo_mux   rd_mux
	( 
...
endmodule //mlab_windowing_data_sc_fifo_altsyncram
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_windowing_data_sc_fifo_cmpr
	( 
	aeb,
	dataa,
...
endmodule //mlab_windowing_data_sc_fifo_cmpr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_windowing_data_sc_fifo_cntr
	( 
	aclr,
	clock,
	cnt_en,
...
endmodule //mlab_windowing_data_sc_fifo_cntr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_windowing_data_sc_fifo_cntr1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //mlab_windowing_data_sc_fifo_cntr1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_windowing_data_sc_fifo_cntr12
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //mlab_windowing_data_sc_fifo_cntr12

//synthesis_resources = lut 91 MLAB 26 reg 183 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_windowing_data_sc_fifo_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	mlab_windowing_data_sc_fifo_altsyncram   FIFOram
	( 
	...
	mlab_windowing_data_sc_fifo_cmpr   almost_full_comparer
	( 
	.aeb(wire_almost_full_comparer_aeb),
	.dataa({8{1'b1}}),
	.datab(wire_usedw_counter_q));
	mlab_windowing_data_sc_fifo_cmpr   three_comparison
	( 
	.aeb(wire_three_comparison_aeb),
	.dataa(wire_usedw_counter_q),
	.datab(8'b00000011));
	mlab_windowing_data_sc_fifo_cntr   rd_ptr_msb
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.q(wire_rd_ptr_msb_q),
	.sclr(sclr));
	mlab_windowing_data_sc_fifo_cntr1   usedw_counter
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.sclr(sclr),
	.updown(valid_wreq));
	mlab_windowing_data_sc_fifo_cntr12   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
...
endmodule //mlab_windowing_data_sc_fifo_a_dpfifo

//synthesis_resources = lut 91 MLAB 26 reg 183 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mlab_windowing_data_sc_fifo_scfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	mlab_windowing_data_sc_fifo_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
	...
	assign
		...
		q = wire_dpfifo_q,
		usedw = wire_dpfifo_usedw;
endmodule //mlab_windowing_data_sc_fifo_scfifo
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module mlab_windowing_data_sc_fifo (
	aclr,
	clock,
	data,
	rdreq,
	...
	mlab_windowing_data_sc_fifo_scfifo	mlab_windowing_data_sc_fifo_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
