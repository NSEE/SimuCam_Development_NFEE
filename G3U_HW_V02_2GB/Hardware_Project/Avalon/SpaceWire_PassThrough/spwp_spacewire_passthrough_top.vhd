...
begin
    ...
    p_pwp_spacewire_passthrough : process(a_clock, a_reset) is
        ...
        begin
            ...
            if ((spw_end0_data_rx_status_rxvalid_i = '1') and (spw_end1_data_tx_status_txrdy_i = '1')) then
    ...
    begin
        if (a_reset = '1') then
            ...
            if (passthrough_enable_i = '1') then
                ...
                p_spw_timecode_passthrough(spw_ct0_timecode_rx_tick_out_i, spw_ct0_timecode_rx_ctrl_out_i, spw_ct0_timecode_rx_time_out_i, spw_ct1_timecode_tx_tick_in_o, spw_ct1_timecode_tx_ctrl_in_o, spw_ct1_timecode_tx_time_in_o);
                -- perform passthrough of data from spw 0 to spw 1
                p_spw_data_passthrough(spw_ct0_data_rx_status_rxvalid_i, spw_ct0_data_rx_status_rxflag_i, spw_ct0_data_rx_status_rxdata_i, spw_ct1_data_tx_status_txrdy_i, spw_ct0_data_rx_command_rxread_o, spw_ct1_data_tx_command_txwrite_o, spw_ct1_data_tx_command_txflag_o, spw_ct1_data_tx_command_txdata_o);
                ...
                p_spw_timecode_passthrough(spw_ct1_timecode_rx_tick_out_i, spw_ct1_timecode_rx_ctrl_out_i, spw_ct1_timecode_rx_time_out_i, spw_ct0_timecode_tx_tick_in_o, spw_ct0_timecode_tx_ctrl_in_o, spw_ct0_timecode_tx_time_in_o);
                -- perform passthrough of data from spw 1 to spw 0
                p_spw_data_passthrough(spw_ct1_data_rx_status_rxvalid_i, spw_ct1_data_rx_status_rxflag_i, spw_ct1_data_rx_status_rxdata_i, spw_ct0_data_tx_status_txrdy_i, spw_ct1_data_rx_command_rxread_o, spw_ct0_data_tx_command_txwrite_o, spw_ct0_data_tx_command_txflag_o, spw_ct0_data_tx_command_txdata_o);
