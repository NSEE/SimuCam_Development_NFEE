...
# 
# SpaceWire_Channel "SpaceWire_Channel" v1.0
...
add_fileset_file spwc_clk_synchronization_ent.vhd VHDL PATH SpaceWire_Channel/SPW_CLK_SYNCHRONIZATION/spwc_clk_synchronization_ent.vhd
