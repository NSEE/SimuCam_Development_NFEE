...
architecture rtl of avstap256_top is
...
begin
	...
	avalon_mm_256_write_ent_inst : entity work.avalon_mm_256_write_ent
		port map(
			clk_i                       => a_avs_clock,
			rst_i                       => a_reset,
			avalon_mm_256_i.address     => avalon_slave_256_address,
			avalon_mm_256_i.write       => avalon_slave_256_write,
			avalon_mm_256_i.writedata   => avalon_slave_256_writedata,
			avstap_clear_i              => s_avstap_write_registers.avstap_control.avstap_clear,
			avalon_mm_256_o.waitrequest => avalon_slave_256_waitrequest,
...
end architecture rtl;                   -- of avstap256_top
