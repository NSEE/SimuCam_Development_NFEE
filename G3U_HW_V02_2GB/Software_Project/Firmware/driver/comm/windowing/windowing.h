...
bool bWindCopyMebWindowingParam(alt_u32 uliMebWindowingParamAddr, alt_u8 ucMemoryId, alt_u8 ucCommCh); /* Copy the meb windowing parameters from the memory address to the specified channel */
