...
void vClearMebDefault() {
	...
	vxDeftMebDefaults.xDebug.usiOLN            = 50;
...
bool bClearFeeDefault(alt_u8 ucFee) {
	...
	if (N_OF_NFEE > ucFee) {
		...
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiVStart                    = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiVEnd                      = 4539;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiChargeInjectionWidth      = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiChargeInjectionGap        = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiParallelToiPeriod         = 1125;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiParallelClkOverlap        = 250;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcdReadoutOrder1stCcd      = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcdReadoutOrder2ndCcd      = 1;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcdReadoutOrder3rdCcd      = 2;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcdReadoutOrder4thCcd      = 3;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiNFinalDump                = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiHEnd                      = 2294;
		...
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiPacketSize                = 32140;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiIntSyncPeriod             = 6250;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.uliTrapPumpingDwellCounter   = 25000;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.bSyncSel                     = FALSE;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucSensorSel                  = 3;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.bDigitiseEn                  = TRUE;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.bDGEn                        = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.bCcdReadEn                   = TRUE;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucReg5ConfigReserved         = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.uliCcd1WinListPtr            = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.uliCcd1PktorderListPtr       = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd1WinListLength         = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcd1WinSizeX               = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcd1WinSizeY               = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucReg8ConfigReserved         = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.uliCcd2WinListPtr            = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.uliCcd2PktorderListPtr       = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd2WinListLength         = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcd2WinSizeX               = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcd2WinSizeY               = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucReg11ConfigReserved        = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.uliCcd3WinListPtr            = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.uliCcd3PktorderListPtr       = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd3WinListLength         = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcd3WinSizeX               = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcd3WinSizeY               = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucReg14ConfigReserved        = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.uliCcd4WinListPtr            = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.uliCcd4PktorderListPtr       = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd4WinListLength         = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcd4WinSizeX               = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcd4WinSizeY               = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucReg17ConfigReserved        = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcdVodConfig              = 3276;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd1VrdConfig             = 3685;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcd2VrdConfig0             = 101;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcd2VrdConfig1             = 14;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd3VrdConfig             = 3685;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd4VrdConfig             = 3685;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcdVgdConfig0              = 12;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcdVgdConfig1              = 204;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcdVogConfig              = 410;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcdIgHiConfig             = 3276;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcdIgLoConfig             = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiReg21ConfigReserved0      = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucCcdModeConfig              = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucReg21ConfigReserved1       = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.bClearErrorFlag              = FALSE;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.uliReg22ConfigReserved       = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd1LastEPacket           = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd1LastFPacket           = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd2LastEPacket           = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucReg23ConfigReserved        = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd2LastFPacket           = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd3LastEPacket           = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd3LastFPacket           = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucReg24ConfigReserved        = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd4LastEPacket           = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiCcd4LastFPacket           = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiSurfaceInversionCounter   = 100;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.ucReg25ConfigReserved        = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiReadoutPauseCounter       = 2000;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaConfig.usiTrapPumpingShuffleCounter = 1000;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiTouSense1                     = 65280;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiTouSense2                     = 65281;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiTouSense3                     = 65282;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiTouSense4                     = 65283;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiTouSense5                     = 65284;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiTouSense6                     = 65285;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd1Ts                        = 65286;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd2Ts                        = 65287;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd3Ts                        = 65288;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd4Ts                        = 65289;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiPrt1                          = 65290;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiPrt2                          = 65291;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiPrt3                          = 65292;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiPrt4                          = 65293;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiPrt5                          = 65294;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiZeroDiffAmp                   = 65295;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd1VodMon                    = 65296;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd1VogMon                    = 65297;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd1VrdMonE                   = 65298;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd2VodMon                    = 65299;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd2VogMon                    = 65300;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd2VrdMonE                   = 65301;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd3VodMon                    = 65302;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd3VogMon                    = 65303;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd3VrdMonE                   = 65304;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd4VodMon                    = 65305;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd4VogMon                    = 65306;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd4VrdMonE                   = 65307;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiVccd                          = 65308;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiVrclkMon                      = 65309;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiViclk                         = 65310;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiVrclkLow                      = 65311;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usi5vbPosMon                     = 65312;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usi5vbNegMon                     = 65313;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usi3v3bMon                       = 65314;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usi2v5aMon                       = 65315;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usi3v3dMon                       = 65316;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usi2v5dMon                       = 65317;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usi1v5dMon                       = 65318;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usi5vrefMon                      = 65319;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiVccdPosRaw                    = 65320;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiVclkPosRaw                    = 65321;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiVan1PosRaw                    = 65322;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiVan3NegMon                    = 65323;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiVan2PosRaw                    = 65324;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiVdigRaw                       = 65325;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiVdigRaw2                      = 65326;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiViclkLow                      = 65327;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd1VrdMonF                   = 65328;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd1VddMon                    = 65329;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd1VgdMon                    = 65330;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd2VrdMonF                   = 65331;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd2VddMon                    = 65332;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd2VgdMon                    = 65333;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd3VrdMonF                   = 65334;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd3VddMon                    = 65335;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd3VgdMon                    = 65336;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd4VrdMonF                   = 65337;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd4VddMon                    = 65338;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiCcd4VgdMon                    = 65339;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiIgHiMon                       = 65340;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiIgLoMon                       = 65341;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiTsenseA                       = 65342;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiTsenseB                       = 65343;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.ucSpwStatusSpwStatusReserved     = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.ucReg32HkReserved                = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiReg33HkReserved               = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.ucOpMode                         = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.uliErrorFlagsErrorFlagsReserved  = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.ucFpgaMinorVersion               = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.ucFpgaMajorVersion               = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.usiBoardId                       = 0;
		vxDeftFeeDefaults[ucFee].xRmapMem.xRmapMemAreaHk.uliReg35HkReserved               = 0;
